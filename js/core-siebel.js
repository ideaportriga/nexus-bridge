...
typeof SiebelApp.Environment == "undefined" && (Namespace("SiebelApp.Environment"), SiebelApp.Environment = function() {
    ...
    return N.GetInstance = function() {
        ...
        if (n)
            if (this.GetToolbar()) this.GetToolbar().HandleResponsePS(n);
                ...
                this.SetToolbar(i), i.Init(), i.Setup(n), i.Show()
            }
        t = e = n = null
    ...
    function a(e) {
        if (e && e.GetMethodArray) {
            ...
            for (var n = 0, r = t.length; n < r; n++) e.constructor.prototype[t[n]] && e[t[n]] !== e.constructor
                .prototype[t[n]] && (e[t[n]] = e.constructor.prototype[t[n]])
        }
    }
    ...
    function rt(r) {
        et.prototype.GetAppPropertySet = function() {
            return r.Clone()
        };
        var i = r.GetChild(0);
        ...
        for (var B = 0; B < o; B++) {
            var j = i.GetChild(B),
                F = j.GetType(),
                I = e.Curry(et.prototype.DefineAccessor, SiebelApp.Environment.constructor.prototype, j);
            switch (F) {
                case u:
                ...
                case w:
                    var W = j.GetProperty(N),
                        q = j.GetProperty(T);
                    W && q && St.call(this, W, q);
                    break;
                case S:
                    var X = new SiebelApp.S_App.PortletSessionMgr;
                    X.ProcessPortletInfo(j);
                    break;
                case E:
                    var V = j.GetProperty(N),
                        J = j.GetProperty(T);
                    V && J && nt.call(this, V, J);
                    break;
                case C:
                ...
                case O:
                    if (SiebelApp.S_App.IsRwd()) {
                        ...
                        (function() {
                            ...
                            require(K, function() {
                                try {
                                    _ !== D ? Tt.call(SiebelApp.S_App, e, t) : (xt.call(SiebelApp.S_App, e, t), n.resolveWith(SiebelApp.S_App, ["SA Applet Object Info"]))
                                } catch (r) {
                                    SiebelJS.Log(r)
                                }
                                e = null
                    ...
                    break;
                case H:
                    SiebelApp.S_App.IsRwd() && Nt.call(this, j);
                    break;
                case P:
    ...
    function vt(e, t, n) {
        ...
        if (e[e.length - 1] === "_sweview") e = "_svf0", t.push({
            ...
            et.prototype.GetTargetViewContainer = function() {
                return r
            }, et.prototype.SetNextTargetViewContainer = function(e) {
    ...
    function wt(n) {
        ...
        for (var u = 0; u < o; u++) {
            ...
            if (c && (!l || l == i.GetZone())) {
                ...
                for (
                    var h in s) !e.IsEmpty(s[h].GetBusComp()) && s[h].GetBusComp().GetVarName() === f && !(s[h].GetPModel() instanceof JSSPropertySet) && s[h].GetPModel() && s[h].GetPModel().HandleNotify(a);
                y.HandleNotify(a)
            } else
                for (var p in M)
    ...
    function Et(n) {
                    ...
                    switch (B) {
                        ...
                        case D:
                            ...
                            (function() {
                                ...
                                var r = function() {
                                    try {
                                        l !== c ? (Tt.call(SiebelApp.S_App, e, t), n.resolveWith(SiebelApp.S_App, [""])) : (xt.call(SiebelApp.S_App, e, t), n.resolveWith(SiebelApp.S_App, ["SA Applet Object Info"]))
                                    } catch (r) {
                                        SiebelJS.Log(r)
                                    }
                                    e = h = null
                                };
                                j.length ? require(j, r) : r()
                            })();
                            break;
                        case d:
                            this.InitializeBO(h);
                        ...
                        case w:
                            ...
                            break;
                        case p:
                            SiebelApp.S_App.IsRwd() && ct.call(), s = SiebelAppFacade.ProxyFactory.MakeObject(B), SiebelAppFacade.ComponentMgr.RegisterLevel(s, this), o.push(s.GetFilesAndProcessObjectInfo(h.GetChild(0)));
                            break;
                        case E:
                            e.IsEmpty(s) || o.push(s.GetFilesAndProcessObjectInfo(h));
                            break;
                        case m:
                            var F = h.GetChildCount();
                            F > 0 && y.ProcessObjectInfo(h.GetChild(0));
                            break;
                        case g:
                            SiebelApp.S_App.IsRwd() ? u = h.Clone() : (y.HandleResponsePS(h.Clone()), y.ProcessObjectInfo(h));
                            break;
                        case x:
                            var I = h.GetProperty(t.get("SWE_PST_EXT_OBJ_INFO")),
                                q = SiebelApp.S_App.getExtObject(I);
                            q ? q.HandleNotify(h.GetChild(0)) : (q = SiebelApp.S_App.RegisterExtObject(h), q && (q.Setup(h.GetChild(0)), I === "Dashboard" ? ut.call(this) : I === "ChatPane" ? at.call(this) : ot.call(this), (I !== "Dashboard" || n.GetProperty(t.get("SWE_RPC_PROP_VIEW_ID")) !== "Dashboard") && q.Show()));
                            break;
                        case T:
                            Nt.call(this, h);
                            break;
        ...
        return o.length > 0 ? $.when.apply($, o).done(function() {
            r.resolveWith(R, ["API "])
        }) : r.resolveWith(R, ["API "]), SiebelApp.S_App.IsRwd() && u && r.done(function() {
    ...
    function At() {
        ...
        SiebelApp.S_App.OnLoadViewContainer(e), this.GetAckView() && SiebelApp.S_App.GotoView(this.GetAckView(), "", "", null), SiebelApp.S_App.PortletSessionMgr || this.InitializeGlobalMenu();
    ...
    function Ut(t, n) {
        Ft = t, nn(), Ft ? (SiebelApp.S_App.uiStatus.Free(), sn(n)) : (tn(), e.IsEmpty(n) || e.Alert(n)), uploadDialogContent = null
    }

    function zt() {
        return It === null && (It = SiebelApp.WebSocketManager.CreateWSHandler(t.get("WS_COMPONENT_TYPE_INLINE_EDIT")), It.timeoutID = null, It.OnClose = Wt, It.OnFail = Xt, It.OnMessage = Vt, Kt()), It
    }

    function Wt() {
        SiebelJS.Log("[DISA][Warning] DISA was closed during file editing."), $t(), tn()
    }
    ...
    function Vt(e, n) {
        ...
        if (Ft) {
            Jt.call(this);
            if (e instanceof Blob) Yt(e, n);
            else {
                var i = e[t.get("WS_MSG_TYPE_IN_ERROR")];
                if (i) {
                    var s = r.GetLocalString(i);
                    s ? Ut(!1, s) : Ut(!1, i), SiebelApp.S_App.uiStatus.Free();
                    return
                }
                var o = e[t.get("WS_INLINEEDIT_FILE_TRANSFERRED")];
                if (o === !0) {
                    Ut(!0), Zt(), en(), SiebelApp.S_App.uiStatus.Free();
                    return
                }
                var u = e[t.get("WS_INLINEEDIT_UPLOAD_STATUS")],
                    a = !0,
                    f;
                switch (u) {
                    case t.get("WS_INLINEEDIT_NEEDUPLOAD_FILESTILLOPEN"):
                        a = !1, f = r.GetLocalString("IDS_ATT_CLOSE_CONFIRM");
                        break;
                    case t.get("WS_INLINEEDIT_NONEEDUPLOAD"):
                        break;
                    case t.get("WS_INLINEEDIT_FILEERROR"):
                        Zt(), f = r.GetLocalString("IDS_ATT_UPLOAD_FAILED");
                        break;
                ...
                Ut(!a, f), SiebelApp.S_App.uiStatus.Free()
            }
        }
    }

    function $t() {
        Jt(), Ft = !1, SiebelApp.S_App.uiStatus.Free(), Zt()
    }

    function Jt() {
        It && It.timeoutID && (window.clearTimeout(It.timeoutID), It.timeoutID = null)
    }

    function Kt() {
        qt = {}, qt[t.get("SWE_PROP_SESSION_RANDOM_NUMBER")] = SiebelApp.S_App.GetSRN(), qt[t.get("SWE_CMD_ARG")] = t.get("SWE_CMD_INVOKE_METHOD_STR"), qt[t.get("SWE_METHOD_STR")] = "AttachAttachment", qt[t.get("SWE_VIEW_RPC_ARG")] = "1"
    }
    ...
    function Yt(e, n) {
        var r = 'Content-Disposition: form-data; name="',
            ...
            u = "--" + o,
            f = "";
        for (var l in qt) qt.hasOwnProperty(l) && (f += u + s, f += r + l + i + qt[l] + s);
        var c = new Blob([f]),
            h = u + s;
        ...
        g.onload = function() {
            ...
            var r = g.result;
            e.send(r), nn(), SiebelApp.S_App.uiStatus.Free()
    ...
    function en() {
        ...
        e.length > 0 && (e.find("#uploadReminder").show(), e.find("#uploadMessage").hide(), e.dialog("widget").find(".ui-dialog-titlebar .ui-dialog-titlebar-close").show(), e.dialog("widget").find("#finishButton").show(), e.dialog("widget").find("#okButton").hide(), e.dialog("open"))
    }
    ...
    function sn(e) {
        ...
        t.length > 0 && (t.find("#uploadMessage").html(e), t.dialog("widget").find(".ui-dialog-titlebar .ui-dialog-titlebar-close").hide(), t.find("#uploadReminder").hide(), t.find("#uploadMessage").show(), t.dialog("widget").find("#finishButton").hide(), t.dialog("widget").find("#okButton").show(), t.dialog("open"))
    }
    ...
    function on() {
        ...
        n[t.get("WS_MSG_COMMAND")] = t.get("WS_MSG_CMD_UPLOAD_FILE"), e.SendMessage(n), e.timeoutID = setTimeout(function() {
            SiebelJS.Log("[DISA][Warning] Uploading file from DISA time out."), SiebelApp.S_App.uiStatus.Free(), Ut(!1)
    ...
    var e = SiebelJS.Dependency("SiebelApp.Utils"),
        ...
        et = function() {
            ...
            et = function() {
                return e
            }, et.prototype = this, e = new et, e.uiStatus = new SiebelApp.UIStatus, e.constructor = et;
            var t = new SiebelApp.CommandManager(e);
            return et.prototype.GetCmdMgr = function() {
                return t
            }, SiebelAppFacade.ComponentMgr.RegisterLevel(e), e
        };
    r = new et, et.prototype.SetExternalActiveApplet = function(e) {
        W = e
    }, et.prototype.GetExternalActiveApplet = function(e) {
        return W
    }, et.prototype.SetShowNewPage = function(e) {
        X = e
    }, et.prototype.GetShowNewPage = function() {
        return X
    }, et.prototype.GetRowCounterTemplateMap = function(e) {
        return H[e]
    }, et.prototype.IsExternalApplet = function(t) {
        return !e.IsEmpty(M[t.GetName()])
    }, et.prototype.RemoveApplet = function(e) {
        this.GetExternalActiveApplet() === e && this.SetExternalActiveApplet(null), delete M[e.GetName()], !e.GetBusComp() || (e.GetBusComp().GetNotifyObject().GetAppletRegistry().length === 1 ? (delete e.GetBusComp().GetNotifyObject(), delete e.GetBusComp()) : e.GetBusComp().GetNotifyObject().DeRegister(e));
    ...
    }, et.prototype.GetPopupPM = function() {
        return D
    }, et.prototype.GetMsgBarPM = function() {
        return _
    }, et.prototype.GetIconMap = function() {
        return O
    }, et.prototype.GetCancelId = function() {
        return V
    }, et.prototype.PushPostBack = function(e, t) {
        w.push({
            callBack: e,
            object: t
        })
    }, et.prototype.DefineAccessor = function(n, r, i, s, o) {
        s = t.get(s);
        var u = null;
        ...
        r = null
    }, et.prototype.GetActiveBusObj = function() {
        return i
    }, et.prototype.SetActiveBusObj = function(e) {
        i = e
    }, et.prototype.GetActiveView = function() {
        return s
    }, et.prototype.SetActiveView = function(e) {
        s = e
    }, et.prototype.SetLayoutLoaded = function(e, t, n, r) {}, et.prototype.SetLayoutUnloaded = function() {}, et.prototype.SetThreadbarSpan = function() {}, et.prototype.ViewUINotLoaded = function() {}, et.prototype.ProcessRPCInfo = function(e) {}, et.prototype.OnUnload = function() {
        SiebelJS.Debug("On Unload")
    }, et.prototype.GetActivePageComp = function() {
        return Y
    }, et.prototype.SetActivePageComp = function(e) {
        Y = e
    }, et.prototype.REPCHK_MRV1 = function() {
        return U
    }, et.prototype.GetAppObjTree = function(e) {
        var t = [];
        return e = !!e && !$.isEmptyObject(e) ? e : this, t.push(e), t
    }, et.prototype.SetSelfProps = function(n) {
        var r = e.Curry(et.prototype.DefineAccessor, et.prototype, n);
        r("GetUserName", "SWE_PROP_USER_ID"), r("GetName", "SWE_PROP_NAME"), r("GetAckView", "SWE_PROP_ACK_VIEW"), SiebelApp.S_App.IsRwd() && r("GetAckApplet", "SWE_APPLET_STR"), r("HeartBeatInterval", "SWE_PROP_HB_INTERVAL"), r("GetCookieName", "SWE_PROP_COOKIE_NAME"), r("GetSessionId", "SWE_RPC_PROP_SESSION_NUMBER"), r("GetSRN", "SWE_PROP_SESSION_RANDOM_NUMBER"), r("UseCookie", "SWE_RPC_PROP_USE_COOKIE"), r("UseSecureCookie", "SWE_RPC_PROP_USE_SECURE_COOKIE"), r("GetPageURL", "SWE_PROP_PAGEURL"), r("GetLoginTimeStamp", "SWE_PROP_LOGIN_TIMESTAMP"), r("GetScriptDir", "SWE_PROP_SCRIPT_DIR"), r("GetSWEReqCount", "SWE_PROP_REQ_COUNT"), r("GetSWEReqCount", "SWE_COUNT_STR"), r("GetStandAloneClient", "SWE_PROP_STANDALONE_CLIENT"), r("GetAccessibilityEnhanced", "SWE_PROP_ACCESSIBILITY_ENHANCED"), r("GetHtmlPopupName", "SWE_PROP_HTML_POPUP_NAME"), r("GetPopupHDBrowser", "SWE_PROP_POPUP_HDBrowser"), r("GetCheckSum", "SWE_PROP_CHECKSUM"), r("GetCancelQueryTimeout", "SWE_PROP_CANCEL_QUERY_TIME_OUT"), r("GetPopupConSize", "SWE_PROP_POPUP_CON_SIZE"), r("GetStrictDate", "SWE_PROP_STRICT_DATE"), r("IsUIEnableDateError", "SWE_PROP_IS_ENABLE_UI_DATE_ERROR_DETECT"), r("UseAnsiCtrls", "SWE_PROP_USE_ANSI_CONTROLS"), r("IsMobileApplication", "SWE_IS_MOBILE_APPLICATION"), r("IsAutoOn", "SWE_IS_AUTO_ON"), r("GetRequiredIndicator", "SWE_PROP_ICON_REQ_INDICATOR"), r("WPName", "SWE_PROP_WP_NAME"), r("ViewTarget", "SWE_VIEW_TARGET"), r("IsSui", "SWE_PROP_SUI_THEME"), r("IsUPTEnabled", "SWE_PROP_ENABLE_UPT"), r("GetBusyTimer", "SWE_BUSY_TIMER"), r("GetEnableElasticGrid", "SWE_ENABLE_ELASTIC_GRID"), r("IsLabelResponsive", "SWE_RESPONSIVE_LABEL"), et.prototype.GetScreenNavTitle = function() {
            return ""
        }, et.prototype.GetDetailCategoryTitle = function() {
            return ""
        };
    ...
    }, et.prototype.GetChildren = function() {
        var e = [],
            t = this.NavCtrlMngr(),
            n = this.GetCmdMgr(),
    ...
    }, et.prototype.IsPhoneLeadingZeroAllowed = function(e) {
        return Z[e] ? !0 : !1
    }, et.prototype.AppendToStrCache = function(e) {
        if (e && e !== "") {
            var t = [];
            CCFMiscUtil_StringToArray(e, t), m = m.concat(t)
        }
    }, et.prototype.AppendToLocalStrCache = function(e) {
        var n = SiebelApp.Utils.IndexOf(g, e);
        return n === -1 && (g.push(e), n = g.length - 1), t.get("SWE_INDEX_PREFIX") + n
    }, et.prototype.LookupStringCache = function(e) {
        var n = "";
        return e >= 0 && e < m.length ? n = m[e] : e && e[0] === t.get("SWE_INDEX_PREFIX") && (e = e.substring(1, e.length), n = g[e]), n
    }, et.prototype.GetStringCache = function() {
        return m
    }, et.prototype.SetStringCache = function(e) {
        m = e
    }, et.prototype.GetNavLevel = function() {
        return K
    }, et.prototype.GetPMPropSet = function() {
        return J
    }, et.prototype.SetPMPropSet = function(e) {
        J = J === null ? e : J, K = K.length === 0 ? (J ? J.GetProperty(t.get("SWE_NAV_EXPANDED_LEVEL")) || "" : "").split(",") : K
    }, et.prototype.SetDiscardUserState = function(e) {
        A = e
    }, et.prototype.GetDiscardUserState = function() {
        return A
    }, et.prototype.GotoView = function(n, r, i, s, o, u) {
        var a;
        this.uiStatus.Busy({
    ...
    }, et.prototype.HideLayout = function(e) {
        if (typeof e == "string")
    ...
    }, et.prototype.GenerateSrvrReq = function(n) {
        var r = CCFMiscUtil_CreatePropSet();
    ...
    }, et.prototype.OnLoadViewContent = function() {
        try {
    ...
    }, et.prototype.RegisterExtObject = function(e) {
    ...
    }, et.prototype.getExtObject = function(e) {
        var t = S.length;
        for (var n = 0; n < t; n++)
            if (S[n].TYPE === e) return S[n].Object;
        return null
    }, et.prototype.UnregisterExtObject = function(e) {
        var t = S.length;
        for (var n = 0; n < t; n++)
            if (S[n].TYPE === e) {
                S.splice(n, 1);
    ...
    }, et.prototype.CanInvokeMethod = function(e) {
        return !0
    }, et.prototype.LogOff = function() {
    ...
    }, et.prototype.OnUnLoadApp = function() {
        var e = "",
            t = "1",
            n = new Date;
    ...
    }, et.prototype.InvokeMethod = function(e, n, r) {
        var i = !0;
        ...
        var u = {},
            a = this;
        typeof r == "object" || r === !0 || r === !1 ? (u.scope = this, u.args = [], u.args.push(e), u.args.push(s), u.async = typeof r.async == "boolean" ? r.async : r, u.selfbusy = r.selfbusy || !1, u.mask = r.mask || !1, u.cb = function() {
            var e = Array.prototype.slice.call(arguments);
            e.push(a.PostExecute.apply(a, arguments)), typeof r.scope != "undefined" && typeof r.scope.cb == "function" && r.scope.cb.apply(r.scope || null, e), e[0] === "ExecuteNamedQuery" && SiebelApp.S_App.uiStatus.Free()
        }) : u = undefined;
        switch (e) {
            case "Query":
                var f = n.Applet;
                delete n.Applet, f.GetBusComp().HandleQuery(n), Pt.call(this, e, s);
                break;
            case "ExecuteNamedQuery":
                var p = CCFMiscUtil_CreatePropSet();
                s.SetProperty(t.get("SWE_CMD_ARG"), t.get("SWE_CMD_INVOKE_METHOD_STR")), s.SetProperty(t.get("SWE_METHOD_STR"), e), s.SetProperty(t.get("SWE_INPUT_PROP_SET_STR"), s.EncodeAsString()), s.SetProperty(t.get("SWE_VIEW_RPC_ARG"), "1"), SiebelApp.S_App.uiStatus.Busy({
                    timeOut: !1,
                    mask: !0,
                    loadMsg: !0
                });
                ...
                if (o) {
                    ...
                    if (d && d.GetBusComp()) {
                        var v = CCFMiscUtil_CreatePropSet();
                        if (!d.InvokeMethod("ImplicitCommit", v)) {
                            i = !1;
                            break
                        }
                    }
                }
                SiebelApp.S_App.CallServer(s, p, !0, u), typeof r == "undefined" && SiebelApp.S_App.uiStatus.Free();
                break;
            case "CanLeaveMainView":
                i = this.CanLeaveMainView(), Pt.call(this, e, s);
                break;
            case "NextApplet":
                o && o.CycleActiveApplet(!1), Pt.call(this, e, s);
                break;
            case "PrevApplet":
                o && o.CycleActiveApplet(!0), Pt.call(this, e, s);
                break;
            case "GotoAppletMenu":
                if (o) {
                    var m = o.GetActiveApplet();
                    m.GetMenu() && m.GetMenu().OnMenuInvoke(t.get("APPLET_NAME"), t.get("SWE_PREPARE_APPLET_MENU"), t.get("SWE_MENU_APPLET"))
                }
                Pt.call(this, e, s);
                break;
            case "GotoApplicationMenu":
                if (C) {
                    var g = C.GetPM().Get("GetPlaceHolder");
                    $("#" + g).children().eq(0).children().eq(0).focus()
                }
                Pt.call(this, e, s);
                break;
            case "GotoCTIToolBar":
                var y = SiebelAppFacade.ComponentMgr.FindComponent({
                    id: t.get("SWE_PST_COMM_TOOLBAR")
                });
                y && y.ExecuteMethod("HandleGotoCTIToolbar"), Pt.call(this, e, s);
                break;
            case "GotoChatPane":
                var b = SiebelApp.S_App.getExtObject("ChatPane");
                b && b.ExecuteMethod("SetFocus"), Pt.call(this, e, s);
                break;
            case "GotoSelectedTreeNode":
                this.CanLeaveMainView() && o && o.GotoSelectedTreeNode();
                break;
            case "ViewList":
                SiebelApp.S_App.NavCtrlMgr.GetVisPM().GetRenderer().SetFocus(), Pt.call(this, e, s);
                break;
            case "Logoff":
                i = this.LogOff();
                break;
            ...
            default:
                if (e === l || e === c) {
                    var d;
                    o && (d = o.GetActiveApplet());
                    if (d && d.GetBusComp() && d.GetBusComp().IsInQueryState()) {
                        var v = CCFMiscUtil_CreatePropSet();
                        d.InvokeMethod(h, v)
                    }
                }
                var w;
                w = this.CallServerApp(e, s, u);
                if (typeof r == "undefined") {
                    var n = [];
                    return n.push(e), n.push(s), n.push(w), i = this.PostExecute.apply(this, n), SiebelApp.S_App.uiStatus.Free(), i
                }
        }
        return i
    }, et.prototype.PostExecute = function(e, t, n) {
        if (n === null) return !1;
        if (e == "GetProfileAttr") {
            var r;
            r = t.GetPropertyAsStr("attrName");
            if (r == "GetJSAddBarDisable")
                if (strResult == "FALSE" || strResult == "False") return !1
        }
        var i = Pt.call(this, e, t);
        return i
    }, et.prototype.SWECount = 0, et.prototype.OnLoadViewContainer = function(e) {
        (function() {
            var t = $("[name=" + e + "]");
            SiebelApp.S_App.IsRwd() && (e ? t = $("#" + e) : SiebelApp.S_App.PortletSessionMgr && (t = $("body"))), et.prototype.GetTargetViewContainer = function() {
                return t
            }, et.prototype.SetNextTargetViewContainer = function(e) {
                SiebelApp.S_App.IsRwd() ? e ? t = $("#" + e) : SiebelApp.S_App.PortletSessionMgr && (t = $("#SiebAppContainer")) : t = $("[name=" + e + "]")
            }, et.prototype.updateTargetViewContainer = function(e, t, n) {
                var r = new $.Deferred;
                return SiebelApp.contentUpdater.AddCallBack(e, function() {
                    r.resolveWith(this, ["LayoutDone"]), t === !0 && this.OnLoadViewContent(), SiebelApp.S_App.IsRwd() && n === !0 && this.OnLoadPageContent(), SiebelApp.LayoutTransitionsMgr && typeof SiebelApp.LayoutTransitionsMgr.ShowTransition == "function" && SiebelApp.LayoutTransitionsMgr.ShowTransition(this.GetTargetViewContainer().attr("id"))
                }, this), SiebelApp.LayoutTransitionsMgr && typeof SiebelApp.LayoutTransitionsMgr.Setup == "function" && SiebelApp.LayoutTransitionsMgr.Setup(this.GetTargetViewContainer().attr("id")), this.GetTargetViewContainer().attr("src", e), SiebelApp.contentUpdater.loadContent(), r.promise()
            }
        })();
    ...
    }, et.prototype.GetLayoutURL = function(n, r, i, s, o) {
    ...
    }, et.prototype.NavCtrlMngr = function() {
        return y
    }, et.prototype.GetDrilldownURL = function(n) {
        ...
        return "start.swe?" + r
    }, et.prototype.DelegateResponse = function(r, i) {
        var s = new $.Deferred,
            o = [],
            u = [],
            a = null;
        ...
        I && j === N && this.GetSRN && e.IsEmpty(this.GetSRN()) && (et.prototype.GetSRN = function() {
            return I
        }), j === N && ht.call(this, H, i);
        var q = e.Curry(et.prototype.DefineAccessor, et.prototype, H);
        ...
        for (var V = 0; V < X; V++) {
            ...
            switch (K) {
                case O:
                    ...
                    break;
                case M:
                    SiebelApp.S_App.IsRwd() && ft.call(this, J);
                    break;
                case _:
                    SiebelApp.S_App.IsRwd() && lt.call(this, J);
                    break;
                case g:
                    wt.call(this, J);
                    break;
        ...
        if (H.GetProperty(t.get("SWE_ALARM_NOTI"))) {
            var tt = SiebelAppFacade.ComponentMgr.FindComponent({
                id: "Alarm Reminder Applet"
            });
            tt && tt.GetPM().ExecuteMethod("notifyAlarm")
        }
        var nt, rt;
        switch (j) {
            case f:
                SiebelApp.S_App.IsRwd() ? (R && (z = R.GetChildByType(t.get("SWE_PST_NEW_VIEW")), z ? (U = z.GetChildByType(t.get("SWE_PST_VIEW_INFO")), U && (W = U.GetProperty(t.get("SWE_PROP_TMPL_ITM_HOLDER")))) : W = "External." + H.GetProperty("ViewId")), nt = vt.call(this, W, u)) : nt = vt.call(this, H.GetProperty(C), u), o.push(this.ProcessNewLayout(H, nt)), a = "refreshview";
                break;
            case l:
                nt = vt.call(this, H.GetProperty(C), u, H.GetProperty(t.get("SWE_APPLET_STR"))), o.push(this.ProcessNewAppletLayout(H, nt)), a = "newappletlayout";
                break;
            case T:
                o = o.concat(this.GetActiveView().HandleRefreshLayout(H, u));
                break;
            case c:
                SiebelApp.S_App.IsRwd() ? (R && (z = R.GetChildByType(t.get("SWE_PST_NEW_VIEW")), z ? (U = z.GetChildByType(t.get("SWE_PST_VIEW_INFO")), U && (W = U.GetProperty(t.get("SWE_PROP_TMPL_ITM_HOLDER")))) : (U = R.GetChildByType(t.get("SWE_PST_VIEW_INFO")), U && (W = U.GetProperty(t.get("SWE_PROP_TMPL_ITM_HOLDER"))))), nt = vt.call(this, W, u)) : nt = vt.call(this, H.GetProperty(C), u), rt = this.ProcessRefreshLayout(H, nt), rt !== !1 ? (o.push(rt), a = "refreshlayout") : u.pop();
                break;
            case h:
                gt.call(this, H);
                break;
            case p:
                this.SetShowNewPage(!0), SiebelApp.S_App.IsRwd() ? H.GetProperty("ViewId") ? nt = vt.call(this, "External." + H.GetProperty("ViewId"), u) : nt = vt.call(this, "", u) : nt = vt.call(this, H.GetProperty(C), u), rt = this.ProcessNewPage(H, nt), rt !== !1 ? (o.push(rt), a = "refreshpage") : u.pop();
            ...
            case D:
                if (this.IsConfigMode()) SiebelApp.UIInteractionMgr.CommitOnToggle();
                    ...
                    var at = window.location.href,
                        mt;
                    mt = at.substring(0, at.indexOf("start.swe") - 1) + "/composer.htm", window.location.replace(mt)
                }
                break;
            default:
        }
        return (e.IsEmpty(R) || j === T) && yt.call(this), SiebelApp.S_App.GetEnablePerfHooks() && SiebelApp.S_App.GetTimer() && SiebelApp.S_App.GetTimer().TimeServerNotification("Processed Server Notifications"), o.push(this.GetFilesAndProcessObjectInfo(H)), j === c && o.length > 0 && o[o.length - 1].done(function() {
            yt.call(SiebelApp.S_App)
        }), this.InvokeCallBack(), e.IsEmpty(k) || k.ManipulateHistoryState(), SiebelApp.S_App.OUIPerfReporter && SiebelApp.S_App.OUIPerfReporter.RefreshData(H), j === v && pt(H), H = null, o.length > 0 ? $.when.apply($, o).done(function() {
            SiebelApp.S_App.ProcessCallbacks(a, u), s.resolve()
        }) : (SiebelApp.S_App.NavCtrlMgr.Show(!0), s.resolve()), (e.IsEmpty(R) || SiebelApp.S_App.IsRwd() && j === p) && dt.call(this), s.promise()
    }, et.prototype.ProcessCallbacks = function(e, t) {
    ...
    }, et.prototype.ProcessNewPopup = function(e) {
    ...
    }, et.prototype.ProcessResponse = function(e, t) {
    ...
    }, et.prototype.SetURLToGo = function(e, t, n, r, i, s) {
        if (n || !B) B = !0, j = e, F = t, I = r, q = i, R = s
    }, et.prototype.RefreshView = function(t, n, r, i) {
        var s =
            null,
    ...
    }, et.prototype.ProcessNewLayout = function(e, n) {
        ...
        r = r.split(" ").join("%20").split("&").join("%26");
    ...
    }, et.prototype.ProcessNewAppletLayout = function(e, n) {
    ...
    }, et.prototype.ProcessRefreshLayout = function(n, r) {
    ...
    }, et.prototype.ProcessNewPage = function(n, r) {
        var i = !1,
        ...
        SiebelApp.S_App.IsRwd() && e.IsTrue(n.GetProperty(t.get("SWE_RPC_FULL_REFRESH"))) && window.location.reload(), a.length == 1 && SiebelApp.S_App.IsRwd() && (a = SiebelApp.S_App.ViewTarget()), a ? a.indexOf("_sweview") > -1 ? this.ClearExistingViewAndBO() : !1 : !1;
        if (!e.IsEmpty(o) && e.IsEmpty(u)) {
            ...
            if (f && a.indexOf("top") != -1 & s.indexOf("SWECmd=Login") != -1) return this.IsConfigMode() ? top.location.replace(s) : window.location.replace(s), !1
        }
        return this.uiStatus.Busy({
            target: this.GetTargetViewContainer(),
            mask: !0
        }), this.SetURLToGo(s, a, !1, o, u, i), !1
    }, et.prototype.InvokeCallBack = function() {
        while (w.length > 0) {
            var e = {};
            e = w.pop(), e.callBack.call(e.object)
        }
    }, et.prototype.GetFilesAndDelegateResponse = function(n, r) {
        var i = new $.Deferred,
            s = null,
        ...
        return i.promise()
    }, et.prototype.GetFilesAndProcessObjectInfo = function(t) {
        var n = new $.Deferred,
            r = null,
        ...
        u = o = null
    }, et.prototype.InitExecContext = function(r, i) {
        SiebelApp.EventManager.addListner("AppInit", this.PushClientPref, this), SiebelApp.S_App.ErrorObject.DecorateErrorCapability(this), tt(), k = new SiebelApp.S_App.HistoryMgr, y = SiebelApp.S_App.NavCtrlMgr;
        var s = r.GetChildByType(n);
        et.prototype.IsRwd = function() {
                return e.IsTrue(s.GetProperty(t.get("SWE_IS_RWD")))
            },
            et.prototype.IsConfigMode = function() {
                return e.IsTrue(s.GetProperty(t.get("SWE_PROP_CONFIG_MODE")))
            }, et.prototype.IsPreviewMode = function() {
                return e.IsTrue(s.GetProperty(t.get("SWE_PROP_PREVIEW_MODE")))
            }, et.prototype.GetActiveWSName = function() {
                return s.GetProperty(t.get("SWE_PROP_WORK_SPACE"))
            }, et.prototype.IsMsgBarEnabled = function() {
                return e.IsTrue(s.GetProperty(t.get("SWE_IS_MSGBAR_ENABLED")))
            }, et.prototype.GetWebSocketSrvrPort = function() {
                return s.GetProperty(t.get("SWE_WEBSOCKET_SERVER_PORT"))
            }, rt.call(this, r), SiebelApp.S_App.IsRwd() && this.PushClientPref();
        ...
        i ? this.ProcessResponse(i) : SiebelApp.S_App.IsRwd() ? At.call(this) : this.LoadClientContainer()
    }, et.prototype.LoadClientContainer = function() {
        SiebelApp.contentUpdater.updateSrc(this.GetClientFrame(), this.GetPageURL() + this.GetClientURL().split("start.swe")[1])
    }, et.prototype.PushClientPref = function(n) {
    ...
    }, et.prototype.InitializeGlobalMenu = function() {
        this.GetTargetViewContainer ? Lt.call(this) : SiebelApp.EventManager.addListner("AppInit", Lt, this)
    }, et.prototype.GetLabel = function() {
        return ""
    }, et.prototype.RegisterControl = function(e, t) {
        b && (b[e] = t)
    }, et.prototype.GetControlClassInstance = function(e) {
        if (b) return b[e]
    }, et.prototype.RegisterConstructorAgainstKey = function(e, t) {
        L && (L[e] = t)
    }, et.prototype.GetConstructorFromKey = function(e) {
        if (L) return L[e]
    }, et.prototype.CallServer = function(n, r, i, s) {
        if (!navigator.onLine && (!IsOfflineModeEnabled() || !this.GetOfflineMode())) return SiebelApp.S_App.uiStatus.Free(), e.Alert(SiebelApp.S_App.LocaleObject.GetLocalString("IDS_CLIENT_AJAX_ERR")), !1;
        s = $.extend({
            selfbusy: !1,
            mask: !0,
            async: !1,
        ...
        if (!s.selfbusy) {
            var o = {};
            s.target && (o.target = s.target), s.mask && (o.mask = s.mask), this.uiStatus.Busy(o)
        }
        r = r || CCFMiscUtil_CreatePropSet();
        if (e.IsTrue(n.GetProperty(t.get("SWE_PROP_CANCELABLE_RPC")))) {
            var u = Math.floor((new Date).getTime() / 1e3),
                a = parseInt(V);
            while (u <= a) u++;
            V = "" + u, n.SetProperty(t.get("SWSE_CANCEL_ID"), V)
        }
        String(n.GetProperty(t.get("SWSE_CMD_STR"))) !== t.get("SWSE_CANCEL_QUERY") && this.SetDefaultArgs(n);
        var f = e.EncodeToQueryString(n),
            l = new Date,
            c = null;
        f = f + "&" + t.get("SWE_TIME_STAMP") + "=" + l.getTime(), this.SetInputPS(n), c = {
            url: this.GetPageURL(),
            data: f.split(" ").join("%20"),
            type: "POST",
            async: s.async,
        ...
        }, SiebelApp.AjaxRequestMgr.Ajax(c), c = null
    }, et.prototype.OnSuccessCallServer = function(t, n, r) {
        var i = this.lp,
            s = this.outputPS,
            o = this.scope,
            u = this.nPR,
            a = new $.Deferred;
        if (u === !0 && r && typeof r.getResponseHeader == "function") {
            if (r.getResponseHeader("swerpc") === null) return window.location.reload(), !0;
            if (r.getResponseHeader("swerpc").toLowerCase() != "true") return window.location.replace(SiebelApp.S_App.GetPageURL()), !0
        }
        i.HB ? t === "OK" && (u = !1, SiebelApp.S_App.uiStatus.Free()) : Ot.call(o);
        if (!e.IsEmpty(t)) {
            if (u === !0) {
                var f = i && i.scope || this,
                    l = o.ProcessResponse(t, f);
                l.done(function() {
    ...
    }, et.prototype.GetSessionCookie = function() {
        if (document.cookie) return document.cookie
    }, et.prototype.SetStaticPickValues = function(e, t) {
        v[e] = t
    }, et.prototype.GetStaticPickValues = function(e) {
        return v[e]
    }, et.prototype.SetActiveView = function(e) {
        s = e
    }, et.prototype.SetActiveBO = function(e) {
        i = e
    }, et.prototype.ClearMainView = function() {
    ...
    }, et.prototype.ClearBusObj = function() {
        i && typeof i.EndLife == "function" && i.EndLife(), i = null
    }, et.prototype.SeblTrace = function(e, t) {}, et.prototype.GetBusObj = function(e) {
        var t = this.GetActiveView();
        return !e && t ? t.GetBusObj() : t && t.GetBusObj().GetName() === e ? t.GetBusObj() : null
    }, et.prototype.GetProfileAttr = function(e) {
        var t, n;
    ...
    }, et.prototype.SetProfileAttr = function(e, t) {
    ...
    }, et.prototype.GetMainView = function() {
        return this.GetActiveView()
    }, et.prototype.CallServerApp = function(e, t, n) {
    ...
    }, et.prototype.NewPropertySet = function() {
        return CCFMiscUtil_CreatePropSet()
    };
    var _t = {};
    et.prototype.RemoveService = function(e) {
        _t[e.GetName()] && delete _t[e.GetName()]
    }, et.prototype.GetService = function(t) {
        if (e.IsEmpty(t)) return !1;
        var n = _t[t];
        return e.IsEmpty(n) ? (n = new SiebelApp.Service, n.SetName(t), _t[n.GetName()] = n, x[t] && typeof window[x[t]] == "function" && new window[x[t]](n), n) : (n.AddRef(), n)
    }, et.prototype.ShowModalDialog = function(e, t, n) {
        return window.showModalDialog(e, t, n)
    }, et.prototype.CreateJSShadow = function(e, t) {
        if (!t) return !1;
        var n = [];
    ...
    var Ft = !1,
        It = null,
        qt;
    return et.prototype.DownloadFile = function(n, r) {
        ...
        if (typeof localStorage == "undefined") {
            ...
            m.prototype.setItem = function(e, t) {
                this.storage[e] = t.toString()
        ...
        var g = function() {
                if (c && h) {
                    ...
                    } else jQuery('<form action="' + c + '" method="post"' + (l ? "" : ' target="_blank"') + ">" + e + "</form>").appendTo("body").submit().remove()
                }
            },
            y = function() {
                if (this.readyState === 4)
                    if (this.status === 200 || this.status === 204) {
                        var t = Ht.encode(this.response);
            ...
            b = function() {
                ...
                var e = c + h,
                    t = Bt() || jt();
                t.onreadystatechange = y, t.open("GET", e), t.responseType = "arraybuffer", t.send()
            },
            w = !1;
        localStorage && (w = localStorage.getItem("isAdfmContainer"));
        if (w) {
            if (SiebelApp.AttachmentMgr.PreviewInMAF) {
                var E = c + h;
                SiebelApp.AttachmentMgr.PreviewInMAF(E, v)
            } else b();
            return
        }
        var S = function() {
                var e = function() {
                    if (this.readyState === 4 && this.status === 200) {
                        ...
                        var n = t.get("SWE_VIEW_ARG"),
                            i = t.get("SWE_APPLET_STR"),
                            s = t.get("SWE_ROW_IDS_STR"),
                            o = t.get("SWE_BCF_FIELD");
                        Qt(n, SiebelApp.S_App.GetActiveView().GetName()), Qt(i, r.GetProperty(i)), Qt(s, r.GetProperty(s)), Qt(o, r.GetProperty(o))
                    }
                };
                SiebelApp.S_App.uiStatus.Busy({
                    mask: !0
            ...
            x = function() {
                ...
                var n = i.GetLocalString("IDS_CLIENT_FILE_DOWNLOAD"),
                    r = i.GetLocalString("IDS_IAE_FILE_DOWNLOAD_PROMPT");
                r = r.replace("%1", v), e.html(r);
                var s = [{
                ...
                SiebelApp.WebSocketManager && s.unshift({
                    ...
                    autoOpen: !1,
                    buttons: s
                }), e.parent().find("button").addClass("siebui-ctrl-btn").addClass("appletButton"), e.dialog("open")
            },
            T = function() {
                var t = $("#uploadFileDialogContent");
                if (t.length <= 0) {
                ...
                t.dialog({
                    ...
                    beforeClose: function() {
                        return Rt() ? e.Confirm(i.GetLocalString("IDS_SWE_POPUP_CLOSEBYX_WARNING")) ? (Ut(!1), !0) : !1 : !0
                    },
                    dialogClass: "siebui-upload-file-dialog-popup",
                    buttons: o
                }), t.find("#uploadMessage").hide(), t.dialog("widget").find("#okButton").hide()
            };
        x()
    }, et.prototype.GetAppletControlInstance = function(e, n, r, i, s) {
    ...
    }, et.prototype.GetInputPS = function() {
        return E
    }, et.prototype.SetInputPS = function(e) {
        E = e
    }, et.prototype.GetCSParam = function() {
        var e = {};
        return e.async = !0, e
    }, et.prototype.SetEnablePerfHooks = function(e) {
        N = e
    }, et.prototype.GetEnablePerfHooks = function() {
        return N
    }, et.prototype.GetTimer = function() {
        return T
    }, et.prototype.SetTimer = function(e) {
        T = e
    }, et.prototype.NotifyTimer = function(e, t) {
        N && T && T[e].apply(T, t)
    }, et.prototype.OfflineCallMethod = function() {}, et.prototype.Drilldown = function(e) {
    ...
    }, et.prototype.TriggerUPTEvent = function(n) {
        var r, i, s;
    ...
    }, et.prototype.OnLoadPageContent = function() {
        var e = SiebelApp.S_App.GetActivePageComp();
        e && e.Show()
    }, r
    ...
    Initialize: function() {
        ...
        var e = $("div[name=popup]").width(),
            t = $("div[name=popup]").height(),
            n = SiebelApp.S_App.LocaleObject.GetLocalString("IDS_SWE_SHOW_AVAILABLE"),
            r = SiebelApp.S_App.LocaleObject.GetLocalString("IDS_SWE_SHOW_SELECTED"),
            i = n,
            s = r;
        $("div[name=popup]").width(e).height(t).dialog("option", "dialogClass", "siebui-mvg-dialog").dialog("option", "buttons", [{
            text: n,
            click: function(e) {
                var t = $(e.currentTarget),
                    o = t.children(".ui-button-text");
                if (t.text() === r) o.text(n).end().attr("title", i), u = SiebelApp.MvgBeautifier.getSelected(), !!u && typeof u.GetObjectType == "function" && (o.attr("un", n), o.attr("rn", "ShowAvailable")), SiebelApp.MvgBeautifier.resizeSelected();
                else if (t.text() === n) {
                    o.text(r).end().attr("title", s);
                    var u = SiebelApp.MvgBeautifier.getAvailable();
                    !!u && typeof u.GetObjectType == "function" && (o.attr("un", r), o.attr("rn", "ShowSelected")), SiebelApp.MvgBeautifier.resizeAvailable()
                }
            }
        }]).find(".siebui-mvg-btn-modifier button").clone(!0).appendTo($("div[name=popup]").parent().find("div.ui-dialog-buttonset")), $("div[name=popup]").parent().find("div.ui-dialog-buttonset").find("button").each(function() {
            $(this).html($(this).val() || $(this).attr("data-display"))
        });
        var o = SiebelApp.S_App.GetActiveView(),
            u = o.GetAppletMap(),
            a;
        for (var f in u) u.hasOwnProperty(f) && (typeof u[f].GetMvgAssocAppletName == "function" && (a = o.GetApplet(u[f].GetMvgAssocAppletName()), !a || (this.availableApplet = a, s = a.GetAppletLabel() || "", s = s ? s + ":" + r : r, a.GetPModel().AttachPostProxyExecuteBinding("ALL", function(e, t, n) {
            SiebelApp.MvgBeautifier.MVGPostProxyExecute(this.Get("GetId"))
        }))), typeof u[f].GetMvgSelectedAppletName == "function" && (a = o.GetApplet(u[f].GetMvgSelectedAppletName()), !a || (this.selectedApplet = a, i = a.GetAppletLabel() || "", i = i ? i + ":" + n : n, a.GetPModel().AttachPostProxyExecuteBinding("ALL", function(e, t, n) {
            SiebelApp.MvgBeautifier.MVGPostProxyExecute(this.Get("GetId"))
        }))));
        a = null, SiebelApp.MvgBeautifier.resizeSelected();
        var l = $("div[name=popup]").parent().find("div.ui-dialog-buttonset").find("button").eq(0);
        l.removeClass().addClass("appletButtons").attr("title", i);
        var c = SiebelApp.MvgBeautifier.getSelected();
        c && typeof c.GetObjectType == "function" && l.children("span").eq(0).attr("ot", "Button").attr("rn", "ShowAvailable").attr("un", n), $("div[name=popup]").find("form").submit(function(e) {
    ...
    resizeAvailable: function() {
        ...
        !e || $("#a_" + e.GetId()).parents("div").eq(0).hide(), e = this.getAvailable(), !e || (SiebelApp.S_App.IsRwd() ? $("#S_A" + SiebelApp.MvgBeautifier.getAvailable().GetPH()).show() : $("#a_" + e.GetId()).parents("div").eq(0).show(), e.GetPModel && !(e.GetPModel() instanceof JSSPropertySet) && (e.GetPModel().OnControlEvent(SiebelApp.Constants.get("PHYEVENT_APPLET_FOCUS")), e.GetPModel().GetRenderer() && e.GetPModel().GetRenderer().resize && e.GetPModel().GetRenderer().resize()), this.elementShowHide(!0))
    },
    resizeSelected: function() {
        $("div[name=popup]").find("td.AppletStylePopup").eq(0).hide();
        var e = this.getAvailable();
        !e || (SiebelApp.S_App.IsRwd() ? $("#S_A" + SiebelApp.MvgBeautifier.getAvailable().GetPH()).hide() : $("#a_" + e.GetId()).parents("div").eq(0).hide()), e = this.getSelected(), !e || ($("#a_" + e.GetId()).parents("div").eq(0).show(), e.GetPModel && !(e.GetPModel() instanceof JSSPropertySet) && (e.GetPModel().OnControlEvent(SiebelApp.Constants.get("PHYEVENT_APPLET_FOCUS")), e.GetPModel().GetRenderer() && e.GetPModel().GetRenderer().resize && e.GetPModel().GetRenderer().resize()), this.elementShowHide(!1))
    },
    ...
    function ForceHistoryEntry(e) {
        var t = history.state,
            n = {};
        n.hnact = t.data.hnact, n.hex = t.data.hex, n.hnactf = "SiebelApp.contentUpdater.ProcessHistoryInfo( '" + e.iframeOrig + "', '" + e.iframeNow + "', '" + t.data.hnact + "' );", document.title = t.title, history.pushState(n, t.title, t.url)
    }

    function UpdateHistoryState() {
        var e, t, n = {},
            r = {};
        return r[consts.get("SWE_HIST_NAV_ACT")] = this.GetAction(), r[consts.get("SWE_HIST_EXCLUDE")] = this.GetExcludeFromHistory(), n.data = r, e = this.GetCaption(), n.title = e, t = "", utils.IsTrue(SiebelApp.S_App.UseCookie()) ? t = this.GetURL().substring(this.GetURL().indexOf("?")) : t = this.GetRefreshUrl().substring(this.GetRefreshUrl().indexOf("?")), n.url = t, document.title = e, history.pushState(n, e, t), SiebelApp.S_App.OfflineCallMethod("ReplaceShortURL", r, e), !0
    }
    ...
    function ReplaceHistoryState() {
        ...
        var i = history.state;
        return i != null && i.title === e && i.url === this.GetURL() ? !0 : (history.replaceState(n, e, t), SiebelApp.S_App.OfflineCallMethod("ReplaceShortURL", r, e), !0)
    }
    ...
    return HistoryMgr.prototype.ProcessObjectInfo = function(e) {
            ...
            if (this.IsInHistoryNavigation()) return this.SetInHistoryNavigation(!1), this.SetCaption(r), this.SetURL(n), this.SetAction(t), !1;
            this.GetExcludeFromHistory() && (this.SetPendingReplace(!0), this.SetExcludeFromHistory(!1));
            if (this.GetAction() && this.GetAction().substring(0, this.GetAction().indexOf(",")) === t.substring(0, t.indexOf(",")))
                if (this.GetURL() !== n) this.SetPendingReplace(!0);
                else {
            ...
            if (this.GetViewExclude() || e.GetProperty(consts.get("SWE_HIST_ISPAGE")) || t.indexOf(consts.get("SWE_HIST_GOTOURL")) > -1) {
                ...
                r = i.title + " ", n = i.url, t = i.data[consts.get("SWE_HIST_NAV_ACT")]
            }
            return this.SetCaption(r), this.SetURL(n), this.SetAction(t), this.SetPendingUpdate(!0), !0
        }, HistoryMgr.prototype.ManipulateHistoryState =
        function() {
        ...
        function c(t) {
            ...
            switch (t.type) {
                ...
                case e.get("SWE_CTRL_MAILTO"):
                    if (t.el) {
                        ...
                        for (var c = 0, h = t.el.length; c < h; c++) {
                            var v = t.el.eq(c).val() ? "mailto:" + t.el.eq(c).val() : "mailto:";
                ...
                case e.get("SWE_CTRL_DATE_TIME_PICK"):
                    ...
                    else l += '<input type=\'text\' class="siebui-ctrl-datetime ${CLASSNAME}" ${ID} ${ATTRS} value="${VALUES}" />'.replace("${VALUES}", t.value || ""), l += '<span class="siebui-icon-datetime" aria-label="' +
                        n + '" >';
                    break;
                ...
                case e.get("SWE_CTRL_EFFDAT"):
                    if (t.el)
                        for (var c = 0, h = t.el.length; c < h; c++) t.el.eq(c).next("span.siebui-icon-effdate").length === 0 && (t.el.eq(c).addClass("siebui-ctrl-effdate siebui-input-popup " + (SiebelApp.S_App.GetDirection() ? "siebui-rtl-input-popup " : " ") + t.className).after('<span class="siebui-icon-effdate" id="' + t.id + '_icon" aria-label="' + o + '" />'), SiebelApp.Utils.IsTrue(SiebelApp.S_App.GetAccessibilityEnhanced()) && t.el.eq(c).attr("aria-describedby", (t.el.attr("aria-describedby") || "") + " " + t.id + "_icon"));
...
if (typeof SiebelApp.S_App.ErrorObject == "undefined") {
    ...
    var consts = SiebelJS
        .Dependency("SiebelApp.Constants"),
...
typeof SiebelApp.Service == "undefined" && (Namespace("SiebelApp.Service"), SiebelApp.Service = function() {
        ...
        return s.prototype.SetInterfaceView = function(e) {
            ...
            if (!
                e.IsEmpty(t) && !e.IsEmpty(i)) return i.InvokeMethod(t, n)
        ...
        }, s.prototype.GetControlValue = function(e) {
            return !0
    ...
    function() {
                    ...
                    if (o === "GotoView") {
                        ...
                        if (t != "View Cache Ready" || this.GetTimerMode() != 1 && this.GetTimerMode() != 2)
                            ...
                            if (t != "Objects Initialized" || this.GetTimerMode() != 1 && this.GetTimerMode() != 2)
                                if (t != "Finished Populate" ||
                                    this.GetTimerMode() != 1 && this.GetTimerMode() != 2) {
                        ...
                        else this.AddStage("Have Layout", u, !0);
    ...
    }()), typeof SiebelAppFacade.ProxyFactory == "undefined" && (SiebelJS.Namespace("SiebelAppFacade.ProxyFactory"), SiebelAppFacade.ProxyFactory = function() {
        function a() {}
        var e = SiebelJS.Dependency("SiebelApp.Constants"),
            t = SiebelJS.Dependency("SiebelApp.Utils"),
        ...
        function v(e) {
            ...
            this.GetPMName = function() {
                ...
                return e.GetName()
            }, u[t] = e, a[t] = {}, f[t] = {}, l[t] = {}, c[t] = {}, h[t] = {}, p[t] = {}, d[t] = {};
            var n;
        ...
        function y(e, t) { //this is to change the property
            ...
            var o = f[this.GetPMName()][e],
                ...
                h = function() {
                    var e = arguments[arguments.length - 1],
                        o = !(e && e instanceof m);
                    return o && (e = new m), e[s] = w.call(this, a, l, arguments, e, o, c ? 0 : 1), r ? w.call(this, t, n, arguments, e[s], o, 0) : e[i] !== !0 && w.call(this, t, n, arguments, e, o, 1), e[s]
                };
            if (o.core) {
        ...
        function w(e, t, n, r, i, s) {
            ...
            if (i) e.length > o.length + s && (o.length = e.length - s), o.push(r);
                ...
                var u = o[o.length - 1];
                u && u instanceof m && e.length > n.length - 1 + s && (o.length = o.length - 1, o.length = e.length - s, o.push(r))
            }
            return e.apply(t, o)
        }
        ...
        function x(e, t, n, r) {
            ...
            var h = function() {
                var e = arguments[arguments.length - 1],
                    o = !(e && e instanceof m);
                return o && (e = new m), e[s] = w.call(this, a, l, arguments, e, o, c ? 0 : 1), r && n.when.call(n.scope) ? w.call(this, t, n.scope, arguments, e[s], o, 0) : e[i] !== !0 && n.when.call(n.scope) && w.call(this, t, n.scope, arguments, e, o, 1), e[s]
            };
            if (o.core) {
                var p = u[this.GetPMName()];
                a = p[e], l = p, o.first || (c = o.first = !0), p[e] = h
        ...
        function T(e, t, n) {
            var o = f[this.GetPMName()][e],
                ...
                l, c, h = function() {
                    var e = arguments[arguments.length - 1],
                        o = !(e && e instanceof m);
                    return o && (e = new m), w.call(this, t, n, arguments, e, o, 1), e[r] === !0 ? e[i] = !0 : e[s] = w.call(this, l, c, arguments, e, o, a ? 0 : 1), e[s]
                };
            if (o.core) {
                var p = u[this.GetPMName()];
        ...
        return v.prototype.Init = function() {
        ...
        }, v.prototype.Setup = function(n) {
            if (u[this.GetPMName()] instanceof SiebelApp.S_App.Applet || u[this.GetPMName()] === SiebelApp.S_App.CommToolbar) {
                var d = n.GetChildByType("apm");
                if (!e.IsEmpty(d)) {
                    var v;
                    if (d) {
                        v = d.EnumProperties(!0);
                        do this.AddProperty(v, d.GetProperty(v)); while (v = d.EnumProperties(!1))
                    }
                    var m = d.GetProperty("Max List Columns Tablet");
                    m !== undefined && m !== null && this.SetProperty("maxListColTablet", m);
                    var g = d.GetProperty("Max List Columns Phone");
                    g !== undefined && g !== null && this.SetProperty("maxListColPhone", g);
                    var y = d.GetProperty("Default Applet Display Mode");
                    y !== undefined && y !== null && this.SetProperty("defaultAppletDisplayMode", y.toString().toLowerCase());
                    var b = d.GetProperty("EnableDragAndDropInList");
                    b !== undefined && b !==
                        null && e.IsTrue(b) && this.SetProperty("enableDragAndDropInList", !0)
                }
            } else {
                var r = "",
                    i = n.GetProperty(t.get("SWE_UIDEF_PR_CTR"));
                if (i) {
                    i = i.split(".");
                    if (i[0]) {
                        r = window[i[0]];
                        for (var s = 1, o = i.length; s < o && r; s++) r = r[i[s]]
                    }
                } else {
                    var a = n.GetProperty(t.get("SWE_PROP_OUI_PRENDERER"));
                    i = SiebelApp.S_App.GetConstructorFromKey(a) + ".";
                    var f = n.GetProperty("SWE_OUI_RENDERER"),
                        l = "",
                        c = 0,
                        h = i.indexOf(".");
                    while (h != -1) {
                        var p = i.substring(c, h);
                        l = l == "" ? window[p] : l[p], c = h + 1, h = i.indexOf(".", c)
                    }
                    r = l || SiebelAppFacade[f] || SiebelAppFacade.PhysicalRenderer
                }
                this.SetRenderer(new r(this))
            }
        ...
        }, v.prototype.HandlePreExecute = function(e, t, n) {
            if (!p[this.GetPMName()]) return;
            var r = p[this.GetPMName()].ALL || [];
            g.call(this, r, e, t, n), r = p[this.GetPMName()].NOT || [], g.call(this, r, e, t, n), r = p[this.GetPMName()][e] || [], g.call(this, r, e, t, n)
        }, v.prototype.HandlePostExecute = function(e, t, n) {
            if (!d[this.GetPMName()]) return;
            var r = d[this.GetPMName()].ALL || [];
            g.call(this, r, e, t, n), r = d[this.GetPMName()].NOT || [], g.call(this, r, e, t, n), r = d[this.GetPMName()][e] || [], g.call(this, r, e, t, n)
        }, v.prototype.HandleNotify = function(e) {
            var t = e.GetProperty(n),
                r = c[this.GetPMName()][t] || [];
            for (var i = 0, s = r.length; i < s; i++) r[i][0].call(r[i][1], e.Clone())
        }, v.prototype.HandleResponsePS = function(e) {
        ...
        }, v.prototype.OnControlEvent = function(e) {
            var n = !1,
                i = null,
                s = [],
                a = arguments.length,
            ...
            return n
        }, v.prototype.EndLife = function() {
            var e = this.GetRenderer();
            e && e.EndLife && e.EndLife(), e = null, this.SetRenderer(e), delete a[this.GetPMName()], delete f[this.GetPMName()], delete l[this.GetPMName()], delete c[this.GetPMName()], delete h[this.GetPMName()], delete p[this.GetPMName()], delete d[this.GetPMName()], delete u[this.GetPMName()]
        }, v.prototype.AddProperty = function(t, n, r) {
            ...
            return !1
        }, v.prototype.SetProperty = function(t, n, r) {
            var i = a[this.GetPMName()];
            if (typeof t == "string" && e.Trim(t) !== "") {
                var s = i[t];
                return s ? (i[t].value = n, y.call(this, t, n), !0) : this.AddProperty(t, n, r)
            }
            return !1
        }, v.prototype.Get = function(e) {
            var t = u[this.GetPMName()] || {},
                n = a[this.GetPMName()][e] || {},
                r = null;
            return n.core === !0 ? typeof t[e] != "undefined" && (r = t[e].call(t)) : r = typeof n.value == "function" ? n.value.call(this) : n.value, r
        }, v.prototype.AddMethod = function(t, n, r) {
            var i = f[this.GetPMName()];
            r = r || {};
            var s = u[this.GetPMName()],
                o = !0;
            return typeof t == "string" && e.Trim(t) !== "" ? (r.core === !0 && (i[t] || typeof s[t] == "function" && (i[t] = {
                core: !0
            })), typeof n == "function" ? i[t] ? r.override ? N.call(this, t, n, r.scope) : r.sequence === !0 ? T.call(this, t, n, r.scope) : r.sequence === !1 && b.call(this, t, n, r.scope, !1) : i[t] = {
                ref: n,
                scope: r.scope || this
            } : o = !1) : o = !1, o
        }, v.prototype.ExecuteMethod = function(e) {
            ...
            return n && n.ref ? n.ref.apply(n.scope, t) : (SiebelJS.Log("Can't find method - [ " + e + " ]"), null)
        }, v.prototype.AttachEventHandler = function(e, t, n) {
        ...
        }, v.prototype.AddValidator = function(e, t) {
        ...
        }, v.prototype.AttachNotificationHandler = function(t, n, r) {
            ...
            return s
        }, v.prototype.AttachPSHandler = function(t, n, r) {
            ...
            return s
        }, v.prototype.AttachPreProxyExecuteBinding = function(t, n, r) {
            ...
            return s
        }, v.prototype.AttachPostProxyExecuteBinding = function(t, n, r) {
            ...
            return s
        }, v.prototype.AttachPMBinding = function(t, n, r) {
            var i = f[this.GetPMName()],
                s = a[this.GetPMName()],
                o = !1;
            r = r || {
            ...
            if (typeof t == "string" && e.Trim(t) !== "" && typeof n == "function")
                if (i[t]) typeof r.when == "function" ? x.call(this, t, n, r, !0) : b.call(this, t, n, r.scope || this, !0);
                else if (s[t]) {
                var u = s[t];
        ...
        function v() {
            SiebelAppFacade.PresentationModel.superclass.constructor.apply(this, arguments), this.retryWaitForObjInfoProcessing = 0
        }
        ...
        function b(e, n, u) {
            ...
            if (a === s) switch (e) {
                case "NewRecord":
                case "CreateRecord":
                    f = this.Get("GetDefaultFocusOnNew");
                    break;
                case "UndoQuery":
                case "UndoRecord":
                case "ExecuteQuery":
                    f = this.Get("GetDefaultFocusOnEdit") || (this.Get("GetActiveControl") || this.Get("GetPrsrvControl") ? (this.Get("GetActiveControl") || this.Get("GetPrsrvControl")).GetName() : null), e !== "ExecuteQuery" && f && this.Get("GetActiveControl") && f === this.Get("GetActiveControl").GetName() && (this.ExecuteMethod("SetActiveControl", null), this.ExecuteMethod("SetFocusToCtrl", f, !1));
                    break;
                case "NewQuery":
                case "RefineQuery":
                    f = this.Get("GetDefaultFocusOnQuery");
                    break;
                case "GotoNext":
                case "GotoPrevious":
                ...
                case "GotoFirstSet":
                case "GotoLastSet":
                    f = this.Get("GetActiveControl") || this.Get("GetPrsrvControl"), this.ExecuteMethod("HandleControlFocus", f), l = !0;
                    break;
                case "WriteRecord":
                    var c = SiebelApp.S_App.GetPopupPM();
                    if (m.call(this, t.get("EVENT_NO_FOCUS")) || c && c.Get("isCurrencyOpen")) l = !0;
                    f = this.Get("GetActiveControl") || this.Get("GetPrsrvControl"), f ? f = f.GetName() : l = !0;
                    break;
                case "InvertSelection":
                case "PositionOnRow":
                    this.Get("MultiSelectMode") && this.ExecuteMethod("FocusOnApplet"), l = !0;
                    break;
                case "DeleteRecord":
                case "CopyRecord":
                    break;
                case "PostChanges":
                    this.SetProperty("ForceFocusOnControl", !0), l = !0;
                    break;
                default:
                    l = !0
            } else if (a === i || !a) {
                this.ExecuteMethod("SetFocusDefaultControl", !1), this.ExecuteMethod("ProcessError");
                switch (e) {
                    case "ExecuteQuery":
                        l = !0;
                        break;
                    case "PostChanges":
                        ...
                        break;
                    case "WriteRecord":
                        m.call(this, t.get("EVENT_NO_FOCUS")), f = this.Get("GetActiveControl") || this.Get("GetPrsrvControl"), f ? f = f.GetName() : l = !0
                }
            } else if (a === o) switch (e) {
                case "InvertSelection":
                case "PositionOnRow":
                    this.Get("MultiSelectMode") && this.ExecuteMethod("FocusOnApplet")
            }!l && !this.Get("HasPickError") && (a === s || a === i || !a) && (f ? this.ExecuteMethod("SetFocusToCtrl", f, !0) : this.ExecuteMethod("FocusFirstControl")), this.ExecuteMethod("SetHasPickError", !1)
        }
        var e = SiebelJS.Dependency("SiebelApp.Utils"),
            t = SiebelJS.Dependency("SiebelApp.Constants"),
        ...
        return SiebelJS.Extend(v, SiebelAppFacade.BasePM), v.prototype.Init = function() {
            SiebelAppFacade.PresentationModel.superclass.Init.apply(this, arguments), SiebelApp.S_App.IsRwd() && e.IsTrue(this.Get("IsObjResponsive")) ? this.AddProperty("GetPlaceholder", this.Get("GetListId") ? this.Get("GetListId") : this.Get("GetFullId")) : this.AddProperty("GetPlaceholder", "s_" + this.Get("GetId") + "_" + "l"), this.AddProperty("GetCaption", SiebelApp.S_App.LookupStringCache(this.Get("GetTitle"))), this.AddProperty("IsPopup", this.Get("GetParentApplet") ? !0 : !1), this.AddProperty("isControlPopupOpen", !1), this.AddProperty("SetFocusToGridCell", !1), this.AddProperty("UpdateUI", !1), this.AddProperty("LandMarkTitle", this.Get("GetAppletLabel") + " " + SiebelApp.S_App.LocaleObject.GetLocalString("IDS_SWE_FORM_APPLET")), this.AddProperty("activeCurrencyCtrl", ""), this.AddProperty("ShowMode", ""), this.AddProperty("IsRefreshLayout", ""), this.AddProperty("RequiredControl", []), this.AddMethod("ExecuteUIUpdate", function() {
                ...
                scope: this
            }), this.AddMethod("HandleControlFocus", y, {
                sequence: !1,
                scope: this
            }), this.AddMethod("ExecuteHandleControlFocus", g, {
                sequence: !1,
                scope: this
            ...
            }), this.AttachPostProxyExecuteBinding("ExecuteQuery", function(t, n, r) {
                var i = SiebelApp.S_App.GetPopupPM();
                !e.IsEmpty(i) && i.Get("IsCancelQryPopupOpen") && (i.ExecuteMethod("ClearPopup"), i.SetProperty("IsCancelQryPopupOpen", !1));
                return
            }), this.AttachPostProxyExecuteBinding("Drilldown", function(t, r, i) {
                ...
                m.call(this, t.get("NOT_PRV_FIELDS")), b.call(this, n, i, s), this.Get("IsRefreshLayout") && this.SetProperty("IsRefreshLayout", !1);
                ...
                this.ExecuteMethod("MaskLeaveField", e, !1)
            }, {
                sequence: !1,
                scope: this
            }), this.AddMethod("LeaveField", function(e, t, n, r) {
                this.ExecuteMethod("MaskLeaveField", e, !0)
            }, {
                sequence: !0,
                scope: this
            }), this.AddMethod("MaskLeaveField", function(e, t) {}), this.AttachNotificationHandler("g", function(e) {
                e.GetProperty("type") === "ClosePopup" && this.ExecuteMethod("ClearPopup")
            }, {
                scope: SiebelApp.S_App.GetPopupPM()
            })
        }, v.GetCtrlTemplate = function(e, n, r, i) {
            var s = CCFMiscUtil_CreatePropSet();
        ...
        }, v.prototype.UpdateModel = function(e) {
        ...
        function o() {
            ...
            var n = this.Get("currPopups"),
                ...
                i = n.length,
                s = 0;
            for (s = 0; s < i; s++) r = n[s], SiebelApp.S_App.IsExternalApplet(r) && r.Close();
        ...
        function a() {
            ...
            r.length == 2 && SiebelApp.MvgBeautifier.Initialize(), 0 == r.length && this.SetProperty("isPopupSI", !0), SiebelApp.S_App.uiStatus.Free(), SiebelApp.S_App.uiStatus.LocalFree()
        }
        ...
        return SiebelJS.Extend(n, SiebelAppFacade.PresentationModel), n.prototype.Init = function() {
            this.AddProperty("state", t.get("POPUP_STATE_UNLOADED")), this.AddProperty("noHide", !1), this.AddProperty("height", 0), this.AddProperty("width", 0), this.AddProperty("source", t.get("POPUP_SOURCE_HI")), this.AddProperty("closeByXDisabled", !1), this.AddProperty("isPrevPopupVisible", !1), this.AddProperty("isPopupClosedByX", !1), this.AddProperty("currPopups", []), this.AddProperty("prevPopups", []), this.AddProperty("url", ""), this.AddProperty("isSIPopup", !1), this.AddProperty("content", ""), this.AddProperty("isCurrencyOpen", !1), this.AddProperty("IsCancelQryPopupOpen", !1), this.AddProperty("CanProcessLayout", !0), this.AddProperty("isPopupSI", !1), this.AddProperty("forceClosePopup", !1), this.AddMethod("SetPopupVisible", r), this.AddMethod("ProcessNewPopup", i), this.AddMethod("ProcessClearPopup", s), this.AddMethod("ClearPopup", o), this.AddMethod("OpenPopup", u), this.AddMethod("OnLoadPopupContent", a), this.AddMethod("StandAlonePopup", function(e, t, n) {}), this.AddMethod("UnloadPopup", function() {}), this.AttachEventHandler("ClosePopupByX", l, {
                core: !0
...
typeof SiebelApp.S_App.PluginBuilder == "undefined" && (SiebelJS.Namespace("SiebelApp.S_App.PluginBuilder"), SiebelApp.S_App.PluginBuilder = function() {
    ...
    return SiebelAppFacade.ResponsiveFieldHO = function() {
        ...
        function t(e, t) {
            var r = SiebelApp.S_App.PluginBuilder.GetHoByName("EventHelper"),
                u, a, f, l = !1;
            return !e || e.length === 0 ? l : (u = e.find('input[type != "checkbox"][type != "radio"], textarea'), u.length > 0 && r && (u = u.filter(function() {
                var e = !1,
                    r = $(this),
                    i = n(r.attr("aria-labelledby"));
                return i = i ? "#" + i : "", a = r.parent().find(i).length ? r.parent().find(i) : r.parent().parent().find(i), a.length == 1 && a.parent()[0] && (a.parent()[0] === r.parent()[0] || a.parent()[0].nextElementSibling === r.parent()[0]) && (a.parent()[0] === r.parent()[0] ? r.parent().addClass("siebui-responsive-field") : r.parent().parent().addClass("siebui-responsive-field"), a.addClass("siebui-responsive-label"), (!this.placeholder || this.placeholder.trim() == "") && a.text() && ($(this).data("placehldr", a.text()), this.placeholder = a.text()), e = !0), a.length && (e && this.value && this.value.trim() != "" || t) && a[0].parentElement.classList.add("siebui-responsive-label-active"), e
        ...
        function u() {
            var e = this.GetPM(),
                i = $("#s_" + e.Get("GetFullId") + "_div"),
                s;
            if (!i || e.Get("IsInQueryMode")) return;
            i.hasClass("siebui-responsive-field-container") || t.call(SiebelAppFacade.ResponsiveFieldHO, i, e.Get("IsInQueryMode")), s = i.find(".siebui-responsive-field input, .siebui-responsive-field textarea");
            for (var o = 0, u = s.length; o < u; o++) {
                var a = s[o].getAttribute("aria-readonly"),
                    f = s[o].getAttribute("aria-labelledby");
                f && f.length && (labelEle = r(s.eq(o), n(f)), labelEle.length == 1 && labelEle.parent()[0] && (labelEle.parent()[0] === $(s[o]).parent()[0] || labelEle.parent()[0].nextElementSibling === $(s[o]).parent()[0]) && (s[o].value.trim() == "" ? (labelEle[0].parentElement.classList.remove("siebui-responsive-label-active"), s[o].placeholder = $(s[o]).data("placehldr") || labelEle.text()) : s[o].value && s[o].value.trim() != "" && labelEle[0].parentElement.classList.add("siebui-responsive-label-active")))
            }
        }
        return e.prototype.Init = function() {}, e.prototype.GetName = function() {
            return "ResponsiveFieldHO"
        }, e.prototype.SetUp = function(e, n) {
            SiebelApp.Utils.IsTrue(SiebelApp.S_App.IsLabelResponsive()) && (t.call(this, n, e.GetPM().Get("IsInQueryMode")), e.AttachPMBinding("UpdateStateChange", u), e.AttachPMBinding("ShowSelection", u))
        }, new e
    ...
    $.fn.focus = function() {
        ...
        $(e.target).closest(".ui-autocomplete").length || $(".ui-autocomplete.ui-widget:visible").hide()
    })
    ...
    return e.prototype.Get_EnableUIUpdate = function(e) {
        ...
        var t = !1,
            n = this.GetAppletRegistry();
        for (var r = 0, i = n.length; r < i; r++)
            if (n[r].GetName() === e.GetName()) {
                t = !0;
                break
            }
        if (!t) {
            ...
            this.GetStateModel()[e.GetName()] = s, n.push(e)
        }
        ...
        for (var n = 0, r = t.length; n < r; n++) {
            if (this.GetEnableUIUpdate(t[n].GetName()) === !1) continue;
            t[n].SetUpdateConditionals(!0), t[n].UpdateRowCounter()
        }
    ...
    function v(e) {
        e && (this.SetActiveAppletInternal(e), e.SetAppletActive(!0, e), e.SetFocusDefaultControl(!0), e.FocusDefaultControl())
    }
    ...
    function m(e) {
        ...
        t && (t.Initialize(), SiebelAppFacade.ComponentMgr.FindComponent({
            id: e
        }).Show(), t.ShowOnly(), t.ShowSelection(), t.HasCustomShadow() && t.shadow && typeof t.shadow.OnLoad == "function" && t.shadow.OnLoad()), v.call(this, this.GetActiveAppletOnLoad())
    }
    ...
    function y(n, r) {
        ...
        if (i) {
            ...
            return e.IsEmpty(o) ? (SiebelApp.S_App.uiStatus.Busy({
                ...
                target: $("#" + o),
                mask: !0
            }), $("#" + o).attr("id", u).attr("src", f)), !e.IsEmpty(f) && !e.IsEmpty(o) && b.call(this, this.GetAppletById(o)), SiebelApp.contentUpdater.AddCallBack(f, function() {
                a.resolveWith(this)
            }, this), r.push({
                func: function(e, t) {
    ...
    function b(e) {
        var t = e.GetBusComp();
        this.RemoveApplet(e), t.GetNotifyObject().GetAppletRegistry().length === 1 ? (t.EndLife(), this.GetBusObj().RemoveBusComp(t)) : t.GetNotifyObject().DeRegister(e)
    }

    function w(e) {
        var n = e.GetProperty(t.get("SWE_PROP_CAN_INVOKE"));
        typeof n == "string" && E.call(this, n)
    }
    ...
    function x(e) {
        var t = e.GetChildCount(),
            n;
        for (n = 0; n < t; n++) T.call(this, e.GetChild(n))
    }
    ...
    return p.prototype.GetPropArray = function() {
        ...
        return n
    }, p.prototype.RemoveApplet = function(e) {
        this.GetActiveApplet() === e && this.SetActiveAppletInternal(null), this.GetActiveAppletOnLoad() === e && this.SetActiveAppletOnLoad(null);
        var t = this.GetAppletMap()[e.GetName()];
        if (t) {
            var n = SiebelAppFacade.ComponentMgr.FindComponent({
                id: t.GetName()
            });
            return n && SiebelAppFacade.ComponentMgr.DeleteComponent(n, this), t.EndLife && t.EndLife(), t = null, delete this.GetAppletMap()[e.GetName()], this.ClearErrorMsg(), !0
        }
        ...
        w.call(this, e), this.ExecuteViewUpdate()
    }, p.prototype.ExecuteViewUpdate = function() {}, p.prototype.CanInvokeMethod = function(e) {
        var t = !0;
        if (!e) return !1;
        ...
        n.PropertyExists(t.get("SWE_PROP_NAME")) && r("GetName", "SWE_PROP_NAME"), r("GetTitle", "SWE_PROP_TITLE"), r("GetPageURL", "SWE_PROP_PAGEURL"), r("IsCacheable", "SWE_PROP_IS_CACHEABLE"), SiebelApp
            .S_App.IsRwd() && (n.PropertyExists(t.get("SWE_PROP_OBJECT_RESPONSIVE")) || n.SetProperty(t.get("SWE_PROP_OBJECT_RESPONSIVE"), "false"), r("IsObjResponsive", "SWE_PROP_OBJECT_RESPONSIVE"), r("GetWebTemplateName", "SWE_PROP_WEBTEMPLATE")), r("GetThreadBarHTML", "SWE_PROP_THREAD_BAR"), r("GetViewType", "SWE_PROP_VIEW_TYPE"), r("IsCacheable", "SWE_PROP_IS_CACHEABLE"), r("GetInvokeMethod", "SWE_PROP_VIEW_INVOKECOMMAND"), r("GetTaskViewTitle", "SWE_PROP_VIEW_TASKVIEWTITLE"), r("GetTaskStepTitle", "SWE_PROP_VIEW_TASKSTEPTITLE"), r("GetActiveTask", "SWE_PROP_VIEW_ACTIVETASK"), r("GetDisableCancelPDQ", "SWE_PROP_DISABLE_CANCEL_PDQ"), SiebelAppFacade.ComponentMgr.FindComponent({
                id: this.GetName()
            }) || (n.GetProperty(t.get("SWE_UIDEF_PM_CTR")) || n.SetPropertyStr(t.get("SWE_UIDEF_PM_CTR"), "siebel/viewpm"), n.GetProperty(t.get("SWE_UIDEF_PR_CTR")) || n.SetPropertyStr(t.get("SWE_UIDEF_PR_CTR"), "siebel/viewpr"), SiebelAppFacade.ComponentMgr.MakeComponent(SiebelApp.S_App, n, this)), SiebelApp.S_App.IsRwd() && w.call(this, n), S.call(this);
        ...
        while (i) {
            ...
            switch (v) {
                ...
                case l:
                    ...
                    break;
                case u:
                    var b = e.Curry(SiebelApp.S_App.constructor.prototype.DefineAccessor, this, i);
                    b("GetObjectType", "SWE_PROP_QTP_OT"), b("GetRepstrName", "SWE_PROP_QTP_RN"), b("GetUIName", "SWE_PROP_QTP_UN");
                    break;
                case a:
                    p = i;
                    break;
                case h:
                    if (SiebelApp.S_App.IsRwd()) {
                        var E = n.Clone(),
                            T = E.GetChildByType(t.get("SWE_PST_CNTRL_LIST"));
                        x.call(this, T)
                    }
                    break;
                default:
                    ...
                    if (c) {
                        c.SetView(this);
                        var N = i.GetChild(0);
                        c.SetName(N.GetProperty(t.get("SWE_PROP_NAME")));
                        var C = {
                            callback: c.ProcessObjectInfo,
                            scope: c,
                            input: {
                                ps: N
                            }
                        };
                        o.MakeComponent(this, N, c, C), d.call(this, c), o.CompleteComponent(this, N, c)
                    }
            }
            i = n.EnumChildren(!1)
        }
        if (p !== null) {
            var k = this.GetApplet(p.GetProperty(t.get("SWE_PROP_NAME"))),
                L = SiebelApp.S_App.GetPopupPM();
            this.SetActiveAppletOnLoad(k);
            if (L.Get("state") === t.get("POPUP_STATE_VISIBLE") && k) {
                var A = L.Get("currPopups"),
                    O = A.length,
                    M = !1;
                for (var _ = 0; _ < O; _++)
                    if (A[_].GetName() === k.GetName()) {
                        M = !0;
                        break
                    }
                if (!M) {
                    A.push(k);
                    var D = (k.GetMvgAssocAppletName || k.GetMvgSelectedAppletName || function() {}).call(k);
                    if (D) {
                        D = this.GetApplet(D);
                        var P = A.length,
                            H = !1;
                        ...
                        if (!H) {
                            var j = this.GetAppletMap();
                            for (var F in j) j[F] === D && A.push(D)
                        }
                    }
                }
            }
    ...
    }, p.prototype.CycleActiveApplet = function(e) {
        var t = !0,
            n = null,
            r = null,
            i = 0,
    ...
    function y() {
        ...
        this.GetCommitPending = function() {
            ...
            X !== e && !this.IsInQueryMode() && (X = e, this.OnCommitStateChange(e))
        };
        var V = !1;
        ...
        var G = ["ExecuteQuery", "RunQuery", "ExecuteAlphaTabQuery"],
            Y = null;
        this.SetCancelQryTimeoutObj = function(e) {
            ...
            if (P === undefined || P === null) P = new SiebelApp.S_App.Currency(this)
        }, this.GetToggleApplet = function() {
            return z
        }, this.SetToggleApplet = function() {
            z || (z = new SiebelApp.S_App.ToggleApplet(this))
        ...
        var Z = SiebelApp.S_App.GetPopupPM();
        Z.Get("state") === t.get("POPUP_STATE_VISIBLE") && Z.Get("currPopups").push(this), this._EndLife = function() {
    ...
    function S() {
        ...
        var n = this.GetActiveControl();
        if (e.IsEmpty(n)) return !1;
        var r = CCFMiscUtil_CreatePropSet(),
            i = this.GetDefaultMethod(),
            s = this.GetDefaultQryMethod();
        if (this.IsInQueryMode() === !0) return s && this.CanInvokeMethod(s) ? this.InvokeMethod(s, r) : this.InvokeMethod("ExecuteQuery", r);
        if (i && this.CanInvokeMethod(i)) return this.InvokeMethod(i, r);
        if (!1 === this.LeaveField(n, this.GetControlValueFromUI(n), !0)) return this.EnterField(n), !1;
        var o = this.GetBusComp();
        return o && o.IsCommitPending() ? this.InvokeMethod("WriteRecord", r) : (this.ClearErrorMsg(), !1)
    }
    ...
    function A(t) {
        if (t.length > 0 && t[0] === this.GetName()) {
            ...
            if (s !== o.GetUIType() || e.IsTrue(o.IsEditEnabled()) && !e.IsTrue(i) || !e.IsTrue(o.IsEditEnabled()) && e.IsTrue(i)) o.IsEditEnabled = function() {
                return i
            }, e.IsTrue(i) ? o.GetUIType = function() {
                return v
            } : o.GetUIType = function() {
                return s
    ...
    function M(e) {
        var n = {},
            ...
            i = this.GetView() ? this.GetView().SetActiveApplet(this) : this.SetAppletActive(!0, this);
        if (i && r) {
            var s = this.GetControls();
            for (var o in s)
                if (s.hasOwnProperty(o)) {
                    var u = s[o];
                    if (u === r) switch (u.GetUIType()) {
                        ...
                        case t.get("SWE_CTRL_TEXT"):
                            if (u.GetPopupType() !== t.get("SWE_CTRL_DETAIL")) break;
                        case t.get("SWE_CTRL_MVG"):
                        case t.get("SWE_CTRL_PICK"):
                        case t.get("SWE_CTRL_EFFDAT"):
                            e || (n.async = !0, n.selfbusy = !0, SiebelApp.S_App.uiStatus.Busy({
                                mask: !0
                            }), n.cb = function() {
    ...
    return y.prototype.IsPure = function() {
    ...
    }, y.prototype.ResetAppletState = function() {}, y.prototype.EndLife = function() {
        if (this.GetMenu()) {
            var e = this.GetMenu().GetPM();
            e && e.EndLife && e.EndLife(), this.GetMenu().SetPM(null), this.SetMenu(null)
        }
        var n = this.GetPModel();
        n && n.EndLife && n.EndLife(), n = null;
        var r = this.GetName().replace(/ /g, "_") + "_" + t.get("SWE_RPC_PROP_APPLET");
        SiebelApp.ThemeManager.unLoadStyle(r);
        var i = this.GetControls();
        for (var s in i) i.hasOwnProperty(s) && (i[s].ClearMethodPropSet(), i[s].SetApplet(null), i[s].ClearRadioGroupPropSet(), delete i[s]);
        i = null, this.SetPModel(n), this.SetView(null), this.SetBusComp(null), this._EndLife(), SiebelApp.S_App.ErrorObject.DeleteErrorObj(this)
        ...
        return this.GetView() ? this.GetView().IsAppletActive(this) : !0
        ...
        return s && o instanceof Array && u >= 0 && u >= o.length && (u = 0), s && o instanceof Array && u >= 0 && u < o.length ? e.IsTrue(o[u]) : !1
        ...
        this.GetFullId = function() {
            return i
        }, !e.IsEmpty(this.GetView()) && !!this.GetBCId() && this.SetBusComp(this.GetView().GetBusObj().GetBusComp(this.GetBCId())), !this.GetBusComp() || this.GetBusComp().Register(this), SiebelApp.S_App.OfflineCallMethod("ProcessAppletSelfProps", this), n = null
        ...
        if (n === "ImplicitCommit") {
            var o = this.GetView();
            if (o && typeof o.GetInvokeMethod == "function" && o.GetInvokeMethod()) return !1
        }
        var u = !0,
            a = !1;
        r = r || CCFMiscUtil_CreatePropSet();
        ...
        if (n === "EditPopup") {
            M.call(this, i), this.FireInvokeMethod(n, r);
            return
        }
        if (n === "OnFocus") {
            var g = !1,
                y = e.IsTrue(l.GetProperty(t.get("SWE_MENU_APPLET"))) || !1;
            if (!e.IsEmpty(this.GetView())) {
                var b = !0;
                this.GetView().IsAppletActive(this) || (b = !1), this.FocusOnMenu(y), g = this.GetView().SetActiveApplet(this), this.FocusOnMenu(!1), g && !b && !y && (this.SetFocusDefaultControl(!0), this.FocusDefaultControl()), this.FireInvokeMethod(n, r)
            } else g = !0, SiebelApp.S_App.GetActiveView() && SiebelApp.S_App.GetActiveView().SetActiveApplet(null), SiebelApp.S_App.GetExternalActiveApplet() !== this && (g = this.SetAppletActive(!0, this));
            return g
        }
        ...
        if (n === "OnEnterKey") return c =
            S.call(this), c === !0 && this.FireInvokeMethod(n, r), c;
        ...
        if (n == "GotoLastSet") {
            var w = -1;
            this.GetBusComp().SetCurRowNum(w)
        }
        ...
        typeof i == "object" || i === !0 || i === !1 ? (T.scope = this, T.args = [], T.args.push(n), T.args.push(l), T.async = typeof i.async == "boolean" ? i.async : i, T.target = i.target, T.selfbusy = i.selfbusy || !1, T.mask = i.mask || !1, T.cb = function() {
            ...
            e.push(this.PostExecute.apply(this, arguments)), typeof i.cb == "function" && i.cb.apply(i.scope || null, e);
            if (!r || n === t.get("SWE_RPC_PROP_STATUS_ERROR")) SiebelApp.S_App.ErrorObject.SetErrorSuppressState(!0), this.ProcessError()
        }) : T = {
            scope: this,
            cb: function() {
                var e = [];
                e.push(n), e.push(l), e.push(k), E = this.PostExecute.apply(this, e)
            }
        };
        ...
        return this.CallServerApplet(n, l, k, T), E
        ...
        return o === !0 && this.FireInvokeMethod(arguments[0], arguments[1]), SiebelApp.S_App.GetEnablePerfHooks() && SiebelApp.S_App.GetTimer() && SiebelApp.S_App.GetTimer().TimeInvokeMethod("", this.GetName(), n, "Finished InvokeMethod"), u === "DownloadFile" && SiebelApp.S_App.DownloadFile(arguments[2], arguments[1]), o
    }, y.prototype.ProcessCancelQueryPopup = function() {},
            y.prototype.CallServerApplet = function(n, r, i, s) {
        var o = !0;
        ...
        var s = SiebelApp.S_App.LocaleObject,
            o = n.GetUIType();
        return !e.IsISO(o, i) && !e.IsEmpty(i) && (o === t.get("SWE_CTRL_DATE_TZ_PICK") || o === t.get("SWE_CTRL_DATE_TIME_PICK") ? r = s.GetStringFromDateTime(i, s.GetDateFormat() + " " + s.GetTimeFormat(), n.GetDisplayFormat() || s.GetDateFormat() + " " + s.GetTimeFormat()) : o === t.get("SWE_CTRL_DATE_PICK") && (r = s.GetStringFromDateTime(i, s.GetDateFormat(), n.GetDisplayFormat() || s.GetDateFormat()))), !e.IsEmpty(r) && r.charAt(0) !== '"' && r.charAt(r.length - 1) !== '"' ? r = '"' + r + '"' : r = i, r
    }, y.prototype.TransformValue = function(n, r, i) {
        var s = SiebelApp.S_App.LocaleObject,
            o = r,
            u = n.GetUIType();
        return u === t.get("SWE_CTRL_DATE_TZ_PICK") || u === t.get("SWE_CTRL_DATE_TIME_PICK") ? (i = this.GetFormattedValue(n, !0), e.IsISO(u, r) && (o = s.GetStringFromDateTime(r, t.get("ISO8601_DATETIME_FORMAT"), n.GetDisplayFormat() || s.GetDateFormat() + " " + s.GetTimeFormat()))) : u === t.get("SWE_CTRL_DATE_PICK") && (i = this.GetFormattedValue(n, !0), e.IsISO(u, r) && (o = s.GetStringFromDateTime(r, t.get("ISO_DATE_FORMAT"), n.GetDisplayFormat() || s.GetDateFormat()))), o === "" && r !== "" && (o = r), i !== o ? o : null
        ...
        if (SiebelApp.S_App.LocaleObject) {
            ...
            if (f) {
                var l = f.
                GetDataType(), c = s, h = t.GetDisplayFormat();
    ...
    }, y.prototype.UpdateStateChange = function() {}, y.prototype.InvokeStateChange = function() {}, y.prototype.OnCommitStateChange = function() {}, y.prototype.Notify = function(e) {
        ...
        this.SetUpdateConditionals(!0), this.UpdateRowCounter()
        ...
        this.UpdateAppletMessage(e, t), (e === "np" || e === "cp") && this.SetCommitPending(L.call(this))
        ...
        if (r.length > 0) {
            if (r[0] === this.GetName()) {
                var s = 0,
                    ...
                    a = !1,
                    f = !0;
                for (var l = 1, c = r.length; l < c; l++) {
                    o = r[l];
                    if (e.IsEmpty(o)) continue;
                    if (o.charAt(0) === "*") {
                        u = o.substr(1), s = 0, a = !0;
                        if (f) {
                            var h = this.GetControl(u);
                            if (h) {
                                var p = h.GetControlType();
                                p && p === "co" && (this.SetEnableExecuteUIUpdate(!0), f = !1)
                            }
                        }
                    }
                    if (o.charAt(0) === "@") {
                        valueSet = CCFMiscUtil_CreatePropSet(), o = o.substr(1), valueSet.DecodeFromString(o);
                        var d = this.GetControl(u);
                        if (d) {
                            for (var v = 0; v < valueSet.GetChildCount(); v++) {
                                var m = valueSet.GetChild(v),
                                    g = m.GetProperty("FieldValue"),
                                    y = m.GetProperty("Selected");
                                if (y) {
                                    var b = g;
                                    d.GetValue = function() {
                                        return b
                            ...
                            d.SetRadioGroupPropSet(valueSet), this.RepopulateField(u, !1, !0)
                        }
                    }
                    o = o.substr(1);
        ...
        if (n.length > 0 && n[0] === this.GetName()) {
            ...
            return this.CanUpdateUI() === !0 && u === !0 && (this.SetUpdateConditionals(!0), this.InvokeStateChange()), u
        }
        ...
        return
    }, y.prototype.HandleImplicitCommit = function(e, t) {
        var n = !0,
            r = null;
        if (t && !t.GetBusComp() && t.GetView() && t.GetView() !== SiebelApp.S_App.GetActiveView()) return !1;
        if (!t || t && !t.DelayPostOnLastActive()) {
            t && (r = t.GetParentApplet());
            if (!e) {
                if (!this.SetActiveCtrlValue()) return n = !1;
                var i = this.GetBusComp();
                if (!t || (i && (i.IsTransientBC() || t.GetBusComp() !== i || !t.IsNoUpdate() && !i.insertPending) || !t.IsEditable()) && t !== this.GetParentApplet() && (!this.GetParentApplet() || this !== this.GetParentApplet()) && !this.GetPopupApplet()) {
                    var s;
                    t && t !== this && (s = !0);
                    if (!this.PostChangesToBC(!0, null, s)) return n = !1
                }
            }
        } else !e && !this.DelayPostOnLastActive() && t.SetAppletToDelayPost(this);
        return n
        ...
        this.IsInQueryMode() ? r = this.GetDefaultFocusOnQuery() : !!this.GetBusComp() && this.GetBusComp().insertPending ? (r = this.GetDefaultFocusOnNew(), n = !1) : (r = this.GetDefaultFocusOnEdit(), n = !0), e.IsEmpty(r) ? this.DispatchFocus(t || !n) : this.SetFocusToCtrl(r, !0), this.SetFocusDefaultControl(!1)
        ...
        n != null && this.SetFormattedValue(n, t)
        ...
        return this.GetBusComp() ? this
            .GetBusComp().IsInQueryState() : !1
        ...
        var e = 0;
        return this.GetBusComp().IsNumRowsKnown() && this.GetBusComp().GetNumRows() === 0 ? e : (e = this.GetBusComp().GetCurRowNum() - this.GetSelection() + this.GetBusComp().GetNotifyObject().GetBegRow(this.GetName()), e)
    ...
    return SiebelJS.Extend(y, SiebelApp.S_App.Applet), y.prototype.EndLife = function() {
        var e = this.GetListOfColumns();
        for (var t in e) e.hasOwnProperty(t) && delete e[t];
        e = null, this._ListAppEndLife(), SiebelApp.S_App.ListApplet.superclass.EndLife.call(this)
    }, y.prototype.GetPropArray = function() {
        var e = SiebelApp.S_App.ListApplet.superclass.GetPropArray.call(this);
        return e.concat(["GetListOfColumns", "GetRowsSelectedArray", "GetRowIdentifier", "HasHierarchy", "GetRowListRowCount", "GetBeginRow", "GetHasTotalRow", "GetTotalMap"])
    }, y.prototype.Show = function() {
        SiebelApp.S_App.ListApplet.superclass
            .Show.call(this)
    }, y.prototype.ShowOnly = function() {
        ...
        return e.concat(["HandleRowSelect", "OnVerticalScroll", "SetMultiSelectMode", "OnClickSort", "OnCtrlBlur", "OnCtrlFocus", "OnDrillDown", "CellChange", "UpdateColIndex", "UpdateColWidth", "DisplaySortInfo", "GetListCol"])
    }, y.prototype.ProcessObjectInfo = function(e) {
        ...
        if (t.Get_DoPopulate(this.GetName()) || this.GetEnableExecuteUIUpdate()) this.RefreshData(!0), this.ShowSelection(), SiebelApp.S_App.GetEnablePerfHooks() && SiebelApp.S_App.GetTimer() && SiebelApp.S_App.GetTimer().TimePopulateApplet(this.GetName(), "Finished Populate Applet");
        ...
        if (n) {
            ...
            if (!this.CanInvokeMethod(n)) {
                n === "GotoPreviousSet" && this.GetSelection() !== 0 && this.GetBusComp().GetRawRecords().length > 0 ? this.HandleRowSelect(0, !1, !1) : n === "GotoNextSet" && this.GetSelection() !== this.GetBusComp().GetRawRecords().length - 1 && this.GetBusComp().GetRawRecords().length > 0 && this.HandleRowSelect(this.GetBusComp().GetRawRecords().length - 1, !1, !1);
                return
            }
    ...
    function M() {
        ...
        this.m_bHierarchyBusComp = !1, this.m_bHierarchyParentIdFld = null, this._EndLife = function() {
            ...
            var n = e.length,
                r = -1;
            if (t)
                for (var i = 0; i < n; i++) t === e[i].Id && (r = i);
            return r
    ...
    function X(e) {
        ...
        switch (t) {
            ...
            case "bInQueryState":
            case "qs":
                this.inQueryState = n != 0, this.inQueryState ? this.SetInQueryState(!0) : this.SetInQueryState(!1)
        }
    ...
    return M.prototype.CanUpdate = function() {
        ...
        while ((t == null || !t.changed || t.setOnServer) && this
            .GetEnumUpdatePos() < this.GetUpdateArray().length) this.SetEnumUpdatePos(this.GetEnumUpdatePos() + 1), t = this.GetUpdateArray()[this.GetEnumUpdatePos()];
        ...
        var t, n, r, i;
        if (this.GetSelection() < 0) return this.SetErrorMsg("BCErrNoActiveRow"), "";
        if (e == null || e == "") return this.SetErrorMsg("BCErrInvalidFieldName"), null;
        field = this.GetField(e);
        if (field == null) return this.SetErrorMsg("BCErrNoSuchField", e), !1;
        t = field.index;
        if (t < 0) return this.SetErrorMsg("BCErrNoSuchField", e), null;
        if (this.GetUpdateArray() != null) {
            r = this.GetUpdateArray()[t];
            if (r != null) return r.newValue
        }
        return this.GetRawRecords()[this.GetSelection()] != null && !this.IsInQueryState() ? (i = this.GetRawRecords()[this.GetSelection()][t], i == null && (i = "")) : i = "", i
        ...
        if (this.inQueryState) return r = this.GetFieldSearchSpec(t), r;
    ...
    return AppletControl.prototype.IsCalc = function() {
        ...
        var n = this.GetName() + "_Label";
        return $("#" + n).css(cssMap[e] || "", t), !0
        ...
        if (cssMap[e]) {
            ...
            $(r).css(cssMap[e], t), e === "Visible" && (t = t === "inline", $(r).nextAll('[id^="' + n + '"]').toggle(t))
    ...
    function s(r, i, s, o) {
        ...
        if (!e.IsEmpty(n)) {
            ...
            var h = {};
            o === undefined ? h.async = !1 : h.async = !0, h.scope = this;
            var p = CCFMiscUtil_CreatePropSet();
    ...
    function s() {
        ...
        this.isShowingPick = function() {
            ...
            y = e
        }, this.SetCurrencyControl = function(e) {
            E = e
    ...
    return s.prototype.CloseServerApplet = function() {
        ...
        if ($("#" + this.GetCCodeFieldName()).length > 0) {
            ...
            this
                .SetCurcyCode(t), this.SetExchDate(n), this.SetAmount(r, !0)
        }
    ...
    return SiebelAppFacade.BasePR = function() {
        function e(e) {
            ...
            this.GetPM = function() {
                return t
            }, SiebelApp.S_App.PluginBuilder.DecorateCapability(this), this.Init(), this._BasePR_EndLife = function() {
                t = null
            }
        }
        return e.prototype = {
    ...
    return SiebelAppFacade.ViewPR = function() {
        function o() {
            SiebelAppFacade.ViewPR.superclass
        ...
        function d() {
            var e, t, n = 0,
                r = 0,
                i, s = $("#s_sctrl_tabScreen"),
                o = SiebelApp.S_App.GetDirection(),
                u = s.scrollLeft();
            t = s.children("ul").children("li");
            for (var a = 0, n = t.length; a < n; a++) r += t.eq(a).width();
            $(".siebui-landing").length === 0 && s.children("ul").width(r), viewport = s.width(), u > 0 ? o ? ($("#sui-right-scroll").removeClass("siebui-tile-scroll-d"), $("#sui-right-scroll").addClass("siebui-tile-right-scroll")) : ($("#sui-left-scroll").removeClass("siebui-tile-scroll-d"), $("#sui-left-scroll").addClass("siebui-tile-left-scroll")) : o ? $("#sui-right-scroll").addClass("siebui-tile-scroll-d") : $("#sui-left-scroll").addClass("siebui-tile-scroll-d"), e = r - (u + viewport), e > 0 ? o ? ($("#sui-left-scroll").removeClass("siebui-tile-scroll-d"), $("#sui-left-scroll").addClass("siebui-tile-left-scroll")) : ($("#sui-right-scroll").removeClass("siebui-tile-scroll-d"), $("#sui-right-scroll").addClass("siebui-tile-right-scroll")) : o ? $("#sui-left-scroll").addClass("siebui-tile-scroll-d") : $("#sui-right-scroll").addClass("siebui-tile-scroll-d")
        }
        var e = SiebelJS.Dependency("SiebelApp.Utils"),
            t = SiebelJS.Dependency("SiebelApp.Constants"),
    ...
    return SiebelAppFacade.AppletMenuPR = function() {
        ...
        return SiebelJS.Extend(t, SiebelAppFacade.BasePR), t.prototype.Init = function() {
            ...
            var e = this.GetPM(),
                t = e.Get("GetPlaceHolder");
            if ($("#" + t + "-menu").length === 0) {
                var n = e.Get("GetConcreteMenu"),
                    r = "<ul id='" + t + "-menu' class='siebui-appletmenu" + (SiebelApp.S_App.GetDirection() ? " siebui-appletmenu-rtl" : "") + "' style='display:none;'>" + this.GenMenuMarkup(n, "siebui-appletmenu") + "</ul>";
                $("#" + t).after(r).next("#" + t + "-menu").menu({}).css({
                    position: "absolute",
                    zIndex: 50
                    ...
                    return !1
                }), this.InjectQTPInfo($("#" + t + "-menu")), n = null, r = null
    ...
    return SiebelAppFacade.AppMenuPR = function() {
        ...
        return SiebelJS.Extend(e, SiebelAppFacade.AppletMenuPR), e.prototype.ShowUI = function() {
            ...
            t.children().hasClass("siebui-appmenu-toggle") || (t.prepend('<a class="siebui-appmenu-toggle" href="#"></a>'), t.children(".siebui-appmenu-toggle").bind("click", function() {
                $(this).parent().hasClass("siebui-appmenu-on") ? ($(this).parent().removeClass("siebui-appmenu-on"), $(".siebui-banner-btn").removeClass("forcehide"), $(".siebui-search-toolbar").removeClass("forcehide")) : ($(this).parent().addClass("siebui-appmenu-on"), $(".siebui-banner-btn").addClass("forcehide"), $(".siebui-search-toolbar").addClass("forcehide"))
            })), t = null
    ...
    return SiebelAppFacade.ListPresentationModel = function() {
        function r(e) {
            SiebelAppFacade.ListPresentationModel.superclass.constructor.call(this, e)
        }
        ...
        var e = SiebelJS.Dependency("SiebelApp.Constants"),
            ...
            n = consts.get("SWE_EXTN_STOP_PROP_OP");
        return SiebelJS.Extend(r, SiebelAppFacade.PresentationModel), r.prototype.Setup = function(t) {
            var n, r, i, s;
            ...
            SiebelAppFacade.ListPresentationModel.superclass.Init.call(this), this.AddProperty("ListOfColumns", c), this.AddProperty("TotalSet", !0), this.AddProperty("MultiSelectMode", !1), this.AddProperty("InQueryMode", !1), this.AddProperty("LandMarkTitle", this.Get("GetAppletLabel") + " " + SiebelApp.S_App.LocaleObject.GetLocalString("IDS_SWE_LIST_APPLET")), this.AddProperty("SortRecord", !1), this.AddProperty("ListDetail", l), this.AddProperty(consts.get("ENABLE_MULTISELECT_COLUMN"), !1), this.AddProperty("ResetScroll", !0), this.AddProperty("ForceFocusOnControl", !1), this.AddProperty("IsDataCleared", !0), this.AddProperty("CloseCtrlPopupInProgress", !1), this.AttachEventHandler(e.get("PHYEVENT_HIER_COLLAPSE"), p, {
                core: !0
            }), this.AttachEventHandler(e.get("PHYEVENT_HIER_EXPAND"), h, {
                core: !0
                ...
                return arguments[arguments.length - 1][t] = !0, arguments[arguments.length - 1][n] = !0, this.ExecuteMethod("OnCtrlBlur", this.Get("GetSelection"), arguments[0], arguments[1])
                ...
                return arguments[arguments.length - 1][t] = !0, arguments[arguments.length - 1][n] = !0, this.ExecuteMethod("OnCtrlFocus", this.Get("GetSelection"), arguments[0], arguments[1])
                ...
                var t = d.call(this, e),
                    ...
                    r = t.length;
                if (r > 0)
                    for (var i = 0; i < r; i++) this.ExecuteMethod("CanInvokeMethod", "NewRecord") && (this.ExecuteMethod("InvokeMethod", "NewRecord"), v.call(this, t[i], n), this.ExecuteMethod("CanInvokeMethod", "WriteRecord") && this.ExecuteMethod("InvokeMethod", "WriteRecord"));
                ...
                t.appletName =
                    this.Get("GetName"), t.rowId = "";
                if (e && e.length > 0) {
                    var r = e.length;
                    for (var i = 0; i < r; i++) t.rowId += n[e[i]].Id, i < r - 1 && (t.rowId += ", ")
                } else t.rowId = n[this.Get("GetSelection")].Id;
                return t
            }), this.AddMethod("ResetScrollpos", function() {}), this.AddMethod("HandleControlFocus", s, {
                sequence: !1,
                scope: this
            }), this.AddMethod("SetFocustoFirstCell", function() {}), this.AttachNotificationHandler(consts.get("SWE_PROP_BC_NOTI_GENERIC"), function(e) {
                var t = this.Get("GetActiveControl");
                if (e.GetProperty("type") === "ClosePopup" && t) {
                    var n = this.Get("IsInQueryMode") ? this.ExecuteMethod("GetFieldValue", t) : this.ExecuteMethod("GetFormattedFieldValue", t);
                    this.ExecuteMethod("CellChange", this.Get("GetSelection"), t.GetFieldName(), n)
                }
                ...
                f.call(this, t, n, "ascending")
            }), this.AttachPostProxyExecuteBinding("SortDescending", function(e, t, n) {
                f.call(this, t, n, "descending")
            }), this.AddMethod("OnScrollComplete", function(e) {}), this.AttachPostProxyExecuteBinding("ScrollPrevData", o), this.AttachPostProxyExecuteBinding("ScrollNextData", o), this.AttachPreProxyExecuteBinding("ALL", function(t, n, r) {
        ...
        }, r.prototype.UpdateModel = function(e) {
            SiebelAppFacade.ListPresentationModel.superclass.UpdateModel.call(this, e), u.call(this, e)
        }, r
    }(), "SiebelAppFacade.ListPresentationModel"
...
typeof SiebelAppFacade.PhysicalRenderer == "undefined" && (SiebelJS.Namespace("SiebelAppFacade.PhysicalRenderer"), define("siebel/phyrenderer", ["siebel/basephyrenderer", "siebel/htmltmplmgr"], function() {
    return SiebelAppFacade.PhysicalRenderer = function() {
                ...
                click: function(e, n) {
                    ...
                    SiebelAppFacade.DecisionManager.PauseVKeyboard($(n)), SiebelAppFacade.ControlBuilder.Calculator({
                        ...
                        close: function(n) {
                            ...
                            r.SetControlValue(e, i), $(this).parents("body").length && $(this).calculator("destroy").next("img").show().end().focus(), r.GetPM().SetProperty("isControlPopupOpen", !1), $.removeData("innerCtrlElem"), r.GetPM().OnControlEvent(t.get("PHYEVENT_CONTROL_FOCUS"), e), SiebelAppFacade.DecisionManager.ResumeVKeyboard($(this))
                        }
                    })
                }
        ...
        function z() {
            ...
            SiebelApp.S_App.IsRwd() && e.IsTrue(t.Get("IsObjResponsive")) ? i = $("#" + t.Get("GetRowCount")) : i = $("#s_" + r + "_rc"), s.length === 0 && (i.parent().prev("td").length ? i.parent().prev("td").append(o) : i.parent().append(o)), n ? (i.addClass("siebui-no-display"), $("#" + r + "_msg").html(n).parent(".siebui-applet-msg").removeClass("siebui-no-display")) : ($("#" + r + "_msg").parent(".siebui-applet-msg").addClass("siebui-no-display"), i.removeClass("siebui-no-display")), i = null
        }
        ...
        function W() {
            ...
            r += '<div align ="center" id = "responseTxt_div"><p id="initTxt_CQ"><b>' +
                s + "</b></p></div><br />";
            var f = '<button id="cancelQry_Ctrl_CQ" class="appletButton" type="button" title="' + a + '" ' + ">" + a + "</button>";
            r += '<div align="center" id = "cancelbtn_div">' + f + "</div>", n.append(r), e.Get("state") === t.get("POPUP_STATE_UNLOADED") && e.Setup(), e.SetProperty("IsCancelQryPopupOpen", !0), e.ExecuteMethod("SetPopupVisible", !0), e.SetProperty("content", n);
            var l = $("#cancelQry_Ctrl_CQ");
            if (l.length !== 0) {
                var c = this;
                l.bind("click", function(n) {
        ...
        function Y(e, t, n) {
            var r = n.ctrlKey || n.altKey || n.shiftKey;
        ...
        function tt(e, n, r) {
            var i = this.GetPM();
            return preState = i.Get("isControlPopupOpen"), i.OnControlEvent(t.get("PHYEVENT_ESCAPE_KEY_PRESS"), n), i.Get("isControlPopupOpen") !== preState
        }
        ...
        function it(e, t, n) {
            t && t.GetUIType() == f && e.attr("autocomplete") && e.autocomplete("widget").not(":hidden").length > 0 && e.val(e.autocomplete("widget").find(".ui-state-focus").text())
        }
            ...
            if (n.keyCode === $.ui.keyCode.TAB) {
                ...
                if (u === null) {
                    var h = null,
                        ...
                        m = n.shiftKey ? v : d;
                    for (c = 0, len = i.length; c < len; c++)
                        if (c !== s) {
                            var g = Number(i.eq(c).attr("data-seq"));
                            if (!h && m(g, o) || h && m(g, o) && m(h, g)) h = g, p = c
                        }
                    p && (u = p)
                }
                u !== null ? (i.eq(u).focus(), n.preventDefault()) : (ut.call(this, n), n.preventDefault())
            }
        }
        ...
        function ft(n, i) {
            var s = i ? i : 0,
                ...
                u = n.GetName(),
                a = n.GetFieldName(),
                f = o.Get("IsInQueryMode"),
                l = o.Get("IsPure"),
                c = o.ExecuteMethod("IsPrivateField", u);
            if ((!e.IsEmpty(a) || c || !l) && n.GetUIType() !== r) {
                var h = "";
                if (f || c || !l) {
                    h = $("[name='" + n.GetInputName() + "']").val() || "";
                    if (!(u !== t.get("SWE_QUERY_COMBO_BOX") && u !== t.get("SWE_QUERY_SEARCH_SPEC") && u !== t.get("SWE_POPUP_QUERY_COMBO_BOX") && u !== t.get("SWE_POPUP_QUERY_SEARCH_SPEC") || !h)) {
                        o.ExecuteMethod("LeaveField", n, h, !0);
                        return
                    }
                    if (f && c || !f || !l) i === undefined || i === null ? h = o.ExecuteMethod("GetFormattedFieldValue", n, !1) : h = o.ExecuteMethod("GetFormattedFieldValue", n, !0, s);
                    else {
                        var p = o.Get("GetRecordSet");
                        e.IsEmpty(p[s][a]) ? h = "" : h = p[s][a]
                    }
                } else i === undefined || i === null ? h = o.ExecuteMethod("GetFormattedFieldValue", n, !0) : h = o.ExecuteMethod("GetFormattedFieldValue", n, !0, s);
                i === undefined || i === null ? (this.EnableControl(n, o.ExecuteMethod("CanUpdate", u)), this.SetControlValue(n, h)) : (this.EnableControl(n, o.ExecuteMethod("CanUpdate", u), s), this.SetControlValue(n, h, s))
            }
        }

        function lt(e, t, n, r) {
            var i = r.GetScriptProperty("Visible");
            if (e) {
                var s = t.nextAll("div#" + t.attr("name") + "_IPEField").text();
                t.nextAll("div#" + t.attr("name") + "_IPEField").hide(), t.nextAll("img#" + t.attr("name") + "_icon").toggle(i), t.toggle(i), t.val(s)
            } else {
                var s = t.val();
                t.nextAll("div#" + t.attr("name") + "_IPEField").toggle(i), t.nextAll("img#" + t.attr("name") + "_icon").hide(), t.hide(), t.nextAll("div#" + t.attr("name") + "_IPEField").children().val(s)
            }
            n !== !0 && t.focus()
        }
        ...
        function mt() {
            ...
            for (var o in r)
                if (r.hasOwnProperty(o)) {
                    var u = r[o],
                        a = u.GetMethodName(),
                        f = u.GetScriptProperty("Visible");
                    if (o === t.get("SWE_POPUP_QUERY_COMBO_BOX") || o === t.get("SWE_POPUP_QUERY_SEARCH_SPEC") || o === t.get("SWE_POPUP_QUERY_EXECUTE") || o === t.get("SWE_QUERY_COMBO_BOX") || o === t.get("SWE_QUERY_SEARCH_SPEC")) {
                        s = $("#" + (u.GetInputName() + "_Ctrl"))[0] || $("#" + u.GetInputName())[0], $(s).length === 0 && e.IsEmpty(u.GetFieldName()) && (s = $('[name="' + u.GetInputName() + '"]')[0]), s = $(s), i ? (s.attr("disabled", "disabled"), o === "PopupQueryExecute" && (s.hasClass("appletButton") && s.removeClass("appletButton"), s.addClass("appletButtonDis"))) : s.attr("disabled") && (s.removeAttr("disabled"), o === "disabled" && (s.hasClass("appletButtonDis") && s.removeClass("appletButtonDis"), s.addClass("appletButton")));
                        continue
                    }
                    if (u.GetUIType() && u.GetUIType()[0] == "J") continue;
                    s = $("#" + (u.GetInputName() + "_Ctrl"))[0] || $("#" + u.GetInputName())[0], !s && e.IsEmpty(u.GetFieldName()) && (s = $('[name="' + u.GetInputName() + '"]')[0]), s = $(s), o === "QueryAssistant" && (i ? s.attr("disabled") && (s.removeAttr("disabled"), s.hasClass("appletButtonDis") && s.removeClass("appletButtonDis"), s.addClass("appletButton")) : (s.attr("disabled", "disabled"), s.hasClass("appletButton") && s.removeClass("appletButton"), s.addClass("appletButtonDis")));
                    if (!i && e.IndexOf(["UndoQuery", "ExecuteQuery", "ShowQueryAssistant"], a) !== -1 || i && e.IndexOf(["NewQuery", "ToggleListRowCount"], a) !== -1) $(s).styleHide();
                    else if (!e.IsEmpty(a) && n.ExecuteMethod("CanInvokeMethod", a)) {
                        if (a !== "Drilldown" || !s.nextAll("[id^='" + u.GetInputName() + "']").is(":visible")) {
                            if (SiebelApp.S_App.IsRwd() && e.IsTrue(n.Get("IsObjResponsive")) && e.IndexOf(["AddRecords", "DeleteRecords", "DeleteAllRecords"], a) !== -1) continue;
                            e.DecideVisibility(s, f)
                        }
                    } else i && a && e.IndexOf(["Find", "AddRecords", "AddAllRecords", "DeleteRecords", "DeleteAllRecords"], a) === -1 ? s.styleHide() : e.DecideVisibility(s, f)
                }
        }
        ...
        function bt() {
            var n = this.GetPM(),
                r = n.ExecuteMethod("GetWSStartRowNum"),
                i = Number(n.Get("GetRowListRowCount")),
                s = i > 1 ? t.get("SWE_ROW_COUNTER_LIST") : t.get("SWE_ROW_COUNTER_FORM"),
                o = [],
                u, a, f;
            r === 0 ? u = t.get("SWE_ROW_COUNTER_NO_RECORDS") : r > 0 ? (o.push(r), i > 1 && o.push(Number(n.Get("GetWSEndRowNum"))), o.push(Number(n.Get("GetNumRows"))), u = s + (n.Get("IsNumRowsKnown") ? t.get("SWE_ROW_COUNTER_TOTAL_KNOWN") : t.get("SWE_ROW_COUNTER_TOTAL_UNKNOWN"))) : r < 0 && r >= -1 * i ? (i > 1 && o.push(Number(-1 * r)), u = s + t.get("SWE_ROW_COUNTER_LAST_RECORD")) : (o.push(Number(-1 - r)), i > 1 && o.push(Number(-1 - Number(n.Get("GetWSEndRowNum")))), u = s + t.get("SWE_ROW_COUNTER_FROM_LAST")), a = SiebelApp.S_App.GetRowCounterTemplateMap(u), f = e.FormatString(a, o);
            var l;
            SiebelApp.S_App.IsRwd() && e.IsTrue(n.Get("IsObjResponsive")) ? l = $("#" + n.Get("GetRowCount")) : l = $("#s_" + n.Get("GetId") + "_rc"), l.addClass("siebui-row-counter").text(f), e.IsTrue(SiebelApp.S_App.IsAutoOn()) && l.attr(consts.get("SWE_PROP_QTP_OT"), consts.get("SWE_CTRL_LABEL")).attr(consts.get("SWE_PROP_QTP_RN"), consts.get("SWE_ROW_COUNTER_NO_RECORDS")).attr(consts.get("SWE_PROP_QTP_UN"), f)
        }
        var e = SiebelJS.Dependency("SiebelApp.Utils"),
            t = SiebelJS.Dependency("SiebelApp.Constants"),
        ...
        return SiebelJS.Extend(F, SiebelAppFacade.BasePR), F.prototype.Init = function() {
            ...
            for (var n in t) {
                ...
                if (r.GetUIType() === w) {
                    ...
                    if (i) {
                        ...
                        s.data("pendingAction") || i.destroy(!0)
                    }
                }
            }
            ...
            n.AddProperty("IsTaggedApplet", O.test(n.Get("GetName"))), X.call(this);
            var p = $("#s_" + u + "_div");
            ...
            if (s || r) {
                var u = arguments[1] ? arguments[1] : t.GetInputName(),
                    a = this.GetIsGridBaseForm() === !0 ? t.GetSeq() : 0,
                    f = $('[name="' + u + '"]')[0] || $("#" + u)[0];
                if (!f) return;
                f = $(f)
            }
            if (r) {
                var l = f.attr("aria-labelledby") || "";
                if (l) {
                    l = l.split(" ", 1);
                    var c = SiebelApp.S_App.GetRequiredIndicator(),
                        h = l[0].replace("/", "\\/"),
                        p = n.Get("GetFullId");
                    $("#" + p).children().find("#" + h).parent().append(c), f.attr("aria-required", "true"), c = h = p = null
                }
                l = null
            }
            switch (t.GetUIType()) {
                case L:
                    t.GetName() === "BookmarkImage" && n.GetPMName() === "Bookmark URL Popup Applet (SWE)_PM" && (f.remove(), $($("table.FormSection")[0]).remove());
                    break;
                case E:
                    var d = f.siblings(".siebui-email-rtc-stripbtn").find(".siebui-email-rtc-stripbtn-link");
                    if (d.length > 0) {
                    ...
                    if (!SiebelApp.S_App.IsRwd() || !e.IsTrue(n.Get("IsObjResponsive"))) {
                        f.text("");
                        var m = f.next("textarea");
                        m.length > 0 && (m.height(t.GetHeight()).width(t.GetWidth()).attr("name", t.GetInputName()).attr("aria-labelledby", t.GetFieldName().replace(/\s+/g, "") + "_Label").attr("aria-label", t.GetDisplayName()).attr("maxlength", t.GetMaxSize() || 256).attr("tabindex", a).addClass("siebui-align-" + t.GetJustification()), this.InjectAppletQTPInfo(m));
                        break
                    };
                default:
                    o.constructor.name === "BasePW" && (f.attr("maxlength", t.GetMaxSize() || 256).attr("tabindex", a).addClass("siebui-align-" + t.GetJustification()), this.InjectQTPInfo(f, t))
            }
            o = f = null
            ...
            switch (n.GetUIType()) {
                ...
                default:
                    c.bind("keydown", {
                        ...
                        return e.data.ctx.HandleKeyEvents($(this), e, $(this).val())
                    }), c.bind("blur", {
                        ctx: this,
                        ctrl: n
                    }, function(e) {
                        V.call(e.data.ctx, e.data.ctrl, this, !1);
                        var n = e.data.ctx.GetPM().OnControlEvent(t.get("PHYEVENT_CONTROL_BLUR"), e.data.ctrl, $(this).val());
                        V.call(e.data.ctx, e.data.ctrl, this, !0)
                    }), c.bind("focus", {
                        ctx: this,
                        ctrl: n
                    }, function(e) {
                        V.call(e.data.ctx, e.data.ctrl, this, !1), e.data.ctx.GetPM().OnControlEvent(t.get("PHYEVENT_CONTROL_FOCUS"), e.data.ctrl, $(this).val())
                    })
            }
            c = null
            ...
            t = arguments && arguments.length ? arguments[1] : null, e = t ? undefined : e;
            if (this.inProgress || e === !0) return !1;
            var n = this.GetPM();
            t = t ? t : n.Get("GetControls");
            for (var r in t) t.hasOwnProperty(r) && ft.call(this, t[r], e)
            ...
            r ? (t.next("." + n).length === 1 ? t.next("." + n).html(r) : t.after("<span class='" + n + "'>" + r + "</span>"), t.next("." + n).toggle(o.GetScriptProperty("Visible"))) : t.next("." + n).hide(), i || !i && e.IsEmpty(s) ? t.val(s).toggle(o.GetScriptProperty("Visible")) : t.hide()
        ...
        }, F.prototype.EnableControl = function(e, n, i) {
            var l, c, h;
            if (!vt(e)) return;
            var d = i === undefined || i === null ? this.GetPM().Get("GetSelection") : i;
            i = i ? i : 0;
            switch (e.GetUIType()) {
                case u:
                case a:
                ...
                case k:
                case w:
                    this.GetUIWrapper(e).SetState(t.get("EDITABLE"), n, d);
                    return;
                case C:
                case r:
                    this.GetUIWrapper(e).SetState(t.get("ENABLE"), n, d);
                    return
            }
            if (e.GetUIType() == E) {
                l = $("[name=" + e.GetInputName() + "]");
                if (l.length > 0) {
                    l.attr("readOnly", !n).attr("aria-readonly", !n);
                    var v = l.siblings(".siebui-email-rtc-stripbtn");
                    v.length > 0 && (n ? $(v).toggle(e.GetScriptProperty("Visible")) : $(v).hide())
                }
            } else l = $("#" + e.GetInputName())[i] || $("[name=" +
                e.GetInputName() + "]")[i], $(l).removeAttr("readOnly").attr("readOnly", !n).attr("aria-readonly", !n)
        }, F.prototype.UpdateUIControls = function(t) {
            var t = this.GetPM().Get("GetControls");
            for (var n in t)
                if (t.hasOwnProperty(n)) {
                    var r = t[n],
                        i = r.GetFieldName();
                    e.IsEmpty(i) || this.EnableControl(r, this.GetPM().ExecuteMethod("CanUpdate", r.GetName()))
                }
            ...
            for (var t in e)
                if (e.hasOwnProperty(t)) {
                    var n = e[t];
                    if (n.GetUIType() === r || n.GetUIType() === C) {
                        var i = this.GetPM().ExecuteMethod("CanInvokeMethod", n.GetMethodName());
                        this.EnableControl(n, i)
                    }
                }
        ...
        }, F.prototype.GetPhysicalControlValue = function(t) {
            var n, r, i = this.GetPM(),
                s = i.Get("GetSelection");
            if (t) {
                i.AddProperty("PhysicalCtrlVal", r), n = $("[name='" + t.GetInputName() + "']"), r = this.GetUIWrapper(t).GetValue(s) || "", i.Get("IsInQueryMode") && t.GetCaseSensitive() && r === SiebelApp.S_App.LocaleObject.GetLocalString("IDS_SWE_CSQ_WATERMARK") && (r = "");
                var o = t.GetUIType();
                switch (o) {
                    case p:
                    case h:
                    case v:
                        i.Get("IsInQueryMode") === !1 && (r = e.ToISOFormat(e.Trim(r), o !== p, t.GetDisplayFormat()) || r);
                        break;
                    case f:
                        n.data("iscache") ? r = i.ExecuteMethod("GetFormattedFieldValue", t) : r = this.FormatDDInQueryMode(t, r)
                }
                i.AddProperty("PhysicalCtrlVal", r)
            }
        }, F
    ...
    return SiebelAppFacade.PopupRenderer = function() {
        ...
        function u() {
            ...
            if (e == t.get("POPUP_STATE_HIDDEN")) {
                $("[name=popup]").dialog("close"), $("[name=popup]").parents(".ui-dialog").eq(0).removeClass("siebui-mvg-dialog");
                ...
                h.SetProperty("isPopupPick", null), h.SetProperty("PickAppletObject", null), h.SetProperty("baseParentAppletId", null), h.SetProperty("isPopupAssoc", null), h.SetProperty("AssocAppletObject", null), h.SetProperty("baseParentAppletId", null), h.SetProperty("isPopupMVGSelected", null), h.SetProperty("MVGSelectedAppletObject", null), h.SetProperty("baseParentAppletId", null), h.SetProperty("isPopupMVGAssoc", null), h.SetProperty("MVGAssocAppletObject", null), h.SetProperty("MVGAssocParentAppletObject", null), h.SetProperty("parentAppletId", null), h.SetProperty("baseParentAppletId", null), h.SetProperty("isPopupNonStandard", null), h.SetProperty("NonStandardAppletObject", null), o.children().remove().end().dialog("option", "buttons", {}).parent().find("div.ui-dialog-buttonset").empty(), this.GetPM().SetProperty("isCurrencyOpen", !1)
            } else if (e == t.get("POPUP_STATE_VISIBLE")) {
                $("div[name=popup]").data("InitDlg", !0), setTimeout(function() {
                    $("div[name=popup]").removeData("InitDlg")
                }, 2), $("div[name=popup]").dialog("open"), $("div[name=popup]").parents("div.ui-dialog").children("div.ui-dialog-titlebar").show(), $("div[name=popup]").dialog("option", "height", "auto").dialog("option", "width", "auto").dialog("option", "resizable", s).dialog("option", "minWidth", n).dialog("option", "minHeight", r), $("div[name=popup]").dialog("option", "position", {
                    my: "center",
                    at: "center",
                    of: window
                });
                ...
                $(".ui-widget-overlay").droppable({
                    drop: function(e, t) {
                        if (t.draggable && (t.draggable.is("tr.jqgrow") || t.draggable.is(".siebui-tile"))) {
                            ...
                            var s = $("#s_" + p.Get("baseParentAppletId") + "_div");
                            ...
                            if (s.offset().left < e.originalEvent.clientX && e.originalEvent.clientX < u && s.offset().top < e.originalEvent.clientY && e.originalEvent.clientY < o) {
                                p.Get("isPopupPick") && (d = p.Get("PickAppletObject"), d.GetPModel().ExecuteMethod("SetSelectionOnDragNDrop", n), r = d.GetPModel().ExecuteMethod("HandleDragNDropInPopup", "PickRecord"));
                                if (p.Get("isPopupMVGAssoc")) {
                                    v = p.Get("MVGAssocParentAppletObject"), p.Get("ismultislectmode") || v.GetPModel().ExecuteMethod("SetSelectionOnDragNDrop", n);
                                    var a = v.GetPModel().ExecuteMethod("HandleDragNDropInPopup", "AddRecords");
                                    a && (r = v.GetPModel().ExecuteMethod("HandleDragNDropInPopup", "CloseApplet"))
                                }
                                if (p.Get("isPopupAssoc")) {
                                    var f = CCFMiscUtil_CreatePropSet();
                                    d = p.Get("AssocAppletObject"), p.Get("ismultislectmode") || d.GetPModel().ExecuteMethod("SetSelectionOnDragNDrop", n), r = d.GetPModel().ExecuteMethod("HandleDragNDropInPopup", "AddRecord")
                                }
                                r ? (t.draggable.detach(), p.SetProperty("isPopupPick", !1), p.SetProperty("isPopupMVGAssoc", !1), p.SetProperty("isPopupMVGSelected", !1), p.SetProperty("isPopupAssoc", !1)) : t.draggable.animate(t.draggable.data().origPosition, "slow")
                            } else t.draggable.animate(t.draggable.data().origPosition, "slow");
                            p.SetProperty("ismultislectmode", !1)
                        }
                    }
                }), c.call(this), SiebelApp.S_App.uiStatus.LocalBusy({
                    mask: !0
                })
            }
        }
        ...
        function l() {
            ...
            i.find("div.ui-jqgrid").length > 0 ? (e === n && (e *= 2), s < e && (e = s * .85), i.width(e), $(window).resize()) : e < n ? (e = n, s < e && (e = s * .85), i.width(e)) : r = !0, r ? setTimeout(function() {
                var t = $("div[name=popup]"),
                    n = t.width();
                t[0] && t[0].scrollWidth > n && t[0].scrollWidth < e && (n = t[0].scrollWidth), s < n && (n = s * .85), t.width(n), a(t)
            }, 3) : a(i), i = null
        }
        ...
        return SiebelJS.Extend(i, SiebelAppFacade.BasePR), i.prototype.Init = function() {
            SiebelAppFacade.PopupRenderer.superclass.Init.call(this), this.AttachPMBinding("state", u), this.AttachPMBinding("url", s), this.AttachPMBinding("content", o), this.AttachPMBinding("OnLoadPopupContent", c), this.AttachPMBinding("OnLoadPopupContent", f), this.AttachPMBinding("StandAlonePopup", this.ProcessStandAlonePopup), SiebelApp.S_App.IsRwd() && this.AttachPMBinding("UnloadPopup", h)
            ...
            t.data("context", this), t.dialog({
                beforeClose: function(t, n) {
                    ...
                    if ($(t.currentTarget, "[class*=ui-dialog-titlebar-close]").length > 0) return e.Confirm(SiebelApp
                        .S_App.LocaleObject.GetLocalString("IDS_SWE_POPUP_CLOSEBYX_WARNING")) ? ($("[name=popup]").data("context").GetPM().OnControlEvent("ClosePopupByX", t), !0) : !1
                }
            })
    ...
    return SiebelAppFacade.ToolbarPM = function() {
        function t(e) {
            SiebelAppFacade.ToolbarPM.superclass.constructor.call(this, e)
        }
        ...
        return SiebelJS.Extend(t, SiebelAppFacade.PresentationModel), t.prototype.Init = function() {
            this.AddProperty("placeholder", "s_toolbar"), this.AddProperty("itemArray", []), this.AddMethod("Update", function() {}, {
                scope: this
        ...
        return SiebelAppFacade.ToolbarRenderer = function() {
            ...
            function l() {
                ...
                for (var a = 0, f = t.length; a < f; a++) {
                    r = t[a], u = r.GetProperty("type");
                    if (u === "Link" || u === "Button") i = n.find("li#tb_" + a), i.length && (s = e.ExecuteMethod("CanInvoke", r.GetProperty("command")), o = s ? " siebui-toolbar-enable " : " siebui-toolbar-disable ", (" " + i[0].className + " ").indexOf(o) <= -1 && i.removeClass("siebui-toolbar-disable siebui-toolbar-enable").addClass(s ? "siebui-toolbar-enable" : "siebui-toolbar-disable").children().eq(0).removeClass("ToolbarButtonOff ToolbarButtonOn").addClass(s ? "ToolbarButtonOn" : "ToolbarButtonOff").children().eq(0).attr("src", !s && !!r.GetProperty("offbitmap") ? r.GetProperty("offbitmap") : r.GetProperty("onbitmap")).removeClass("ToolbarButtonOff ToolbarButtonOn").addClass(s ? "ToolbarButtonOn" : "ToolbarButtonOff"))
                }
                n = i = t = null
            }
            ...
            return SiebelJS.Extend(s, SiebelAppFacade.BasePR), s.prototype.Init = function() {
                ...
                for (l = 0; l < i.length; l++) {
                    var p = i[l],
                        d = e.ExecuteMethod("CanInvoke", p.GetProperty("command")),
                        v = p.GetProperty("type"),
                        m = p.GetProperty("toolbarname") || "",
                        g = p.GetProperty("name") || "",
                        y = p.GetProperty("offbitmap"),
                        b = p.GetProperty("onbitmap"),
                        w = "siebui-toolbar-" + m.replace(/\s+/g, "-").toLowerCase(),
                        E = $("#" + w).length > 0 ? "#" + w : "#" + s,
                        S = "N";
                    a[E] || (a[E] = $("#" + w).length > 0 ? "role='navigation' aria-label='" + m : "role='toolbar' aria-label='" + f), c = o[E] || "", u.call(this, p.childArray) && (S = "Y", d = !0);
                    switch (v) {
                        case t:
                        case n:
                        case r:
                            var x = p.GetChildByType(consts.get("SWE_PST_QTP_INFO")),
                                T = d ? "ToolbarButtonOn" : "ToolbarButtonOff";
                            c += "<li id = 'tb_" + l + "' class='" + (d ? "siebui-toolbar-enable" : "siebui-toolbar-disable") + (h ? " siebui-rtl-element-right" : "") + "' data-cmd='" + p.GetProperty("command") + "' data-subtoolbar='" + S + "' role = 'button'  title = '" + p.GetProperty("caption") + "' name='" + g + "' tabindex='" + (l === 0 ? 0 : -1) + "' data-tbindex='" + l + "'>" + "<span class='siebui-icon-tb-" + g.toLowerCase().replace(/ /g, "_") + " " + T + "'>" + "<img src='" + (!d && !!y ? y : b) + "' class='" + T + "' ", x && (c += consts.get("SWE_PROP_QTP_OT") + "='" + x.GetProperty(consts.get("SWE_PROP_QTP_OT")) + "' " + consts.get("SWE_PROP_QTP_RN") + "='" + x.GetProperty(consts.get("SWE_PROP_QTP_RN")) + "' " + consts.get("SWE_PROP_QTP_UN") + "='" + x.GetProperty(consts.get("SWE_PROP_QTP_UN")) + "'"), c += "/><span class='siebui-toolbar-text'>" + p.GetProperty("caption") + "</span></span></li>", o[E] = c
                    }
                }
                var N;
                for (var C in o) N = "<ul class='siebui-toolbar' " + (a[C] || "") + "' >", o[C] = N + o[C] + "</ul>", $(C).html(o[C]), $(C).find("li.siebui-toolbar-enable").eq(0).attr("tabindex", "0");
                ...
                $("#_sweviewbar").length && $("#_sweviewbar").before('<div class="siebui-callout-one"></div><div class="siebui-callout-two"></div>'), (SiebelApp.Utils.IsTrue(SiebelApp.S_App.IsSui()) || o()) && $(".siebui-button-toolbar").length && ($(".siebui-button-toolbar").addClass("siebui-closed"), $("html").bind("click", function(e) {
...
typeof SiebelAppFacade.ErrorObjectRenderer == "undefined" && (SiebelJS.Namespace("SiebelAppFacade.ErrorObjectRenderer"), define("siebel/errorobjectrenderer", ["siebel/basephyrenderer"], function() {
    ...
    }, n.prototype.ProcessLinksObjectInfo = function(e, t) {
        if (e == null || e == undefined) return;
    ...
    return s.prototype.Initialize = function(e) {
        ...
        } else e ? this.screenNavigationDone ? (this.Refresh(), this.GetscreenNavigationPM().SetProperty("GetDataReload", !1)) : $("#" + t.get("SWE_PROP_NC_ID_SCREEN_CONTROL")).length === 1 && (this.GetscreenNavigationPM().Show(), this.screenNavigationDone = !0) : $("#" + t.get("SWE_PROP_NC_ID_VIEW_CONTROL")).length === 1 && (this.GetdetailNavigationPM().SetProperty("GetDataReload", !0), this.GetdetailNavigationPM().Show(), this.GetdetailNavigationPM().SetProperty("GetDataReload", !1)), this.pdqPMDone || (this.GetPDQPM().Show(), this.pdqPMDone = !0);
        ...
        if (!e.IsEmpty(n)) {
            ...
            if (!e.IsEmpty(s)) {
                ...
                for (var f = 0; f < a; f++) {
                    var l = u[f].split(".js");
                    l[l.length - 1] === "" && l.pop(), u[f] = l.join(".js")
                }
                if (u.length > 0) {
                    var c = this,
                        h, p;
                    ...
                    function d() {
                        try {
                            u.length && (p = require(u[u.length - 1]), h = require(u[u.length - 2])), h && r.SetProperty(SiebelApp.Constants.get("SWE_UIDEF_PM_CTR"), h), p && r.SetProperty(SiebelApp.Constants.get("SWE_UIDEF_PR_CTR"), p), o.call(c, r)
                        } catch (e) {}
                        n = c = null
                    }
                    var v = e.PrepareModuleInfo(n);
                    v.length > 0 ? require(v, d) : d()
                }
                fileArray = null
            }
        }
    ...
    return SiebelAppFacade.PDQPresentationModel = function() {
        ...
        return SiebelJS.Extend(n, SiebelAppFacade.BasePM), n.prototype.Init = function() {
            SiebelApp.S_App
                .IsRwd() ? (SiebelAppFacade.PDQPresentationModel.superclass.Init.call(this), this.AddProperty("GetContainer", "")) : this.AddProperty("GetContainer", "s_pdq"), this.AddProperty("PDQRefresh", !1), this.AddProperty("bInQueryState", !1), this.AddProperty("PrevSelectedPQDItem", 0), this.AddMethod("InvokeMethod", null, {
                    core: !0
                    ...
                    r.call(this, e), SiebelApp.S_App.IsRwd() && this.Get("GetPDQDone") != 1 && this.ExecuteMethod("Show", !1, !0), this.SetProperty("PDQRefresh", !0)
    ...
    return SiebelAppFacade.VisDropdownPresentationModel = function() {
        ...
        function i(n) {
            ...
            var r = {};
            return r.screenName = n.GetProperty(e.get("SWE_PROP_NC_SCREEN_NAME")), r.defaultViewName =
                n.GetProperty(e.get("SWE_PROP_NC_VIEW_NAME")), r.captionName = n.GetProperty(e.get("SWE_PROP_NC_CAPTION")), r.tabIcon = n.GetProperty(e.get("SWE_PROP_NC_SCREEN_TAB_ICON")), r
        }
        var e = SiebelJS.Dependency("SiebelApp.Constants"),
            t = SiebelJS.Dependency("SiebelApp.Utils");
        return SiebelJS.Extend(n, SiebelAppFacade.PresentationModel), n.prototype.Init = function() {
    ...
    return SiebelAppFacade.VisDropdownPhyRenderer = function() {
        ...
        function i(t) {
            ...
            n && typeof n.GetProperty == "function" && t.attr("ot", n.GetProperty(i)).attr("rn", n.GetProperty(s)).attr("un", n.GetProperty(o));
...
if (typeof SiebelApp.S_App.DatumPhoneObject == "undefined") {
    ...
    SiebelApp.S_App.DatumPhoneObject = function() {
        ...
        return SiebelJS.Extend(e, SiebelApp.S_App.DatumObject), e.prototype.GetAsFormattedString = function(e) {
            ...
            s = this.m_sValue.toString().replace(/,/g, ""), u.length === 0 && o && (this.m_bCustomFormat && !this.m_bLeadingZeroRemoved && this.m_sFormat.replace("0", "#"), s = "0" + s);
            if (this.m_sFormat)
            ...
            var n = "",
                r = !1;
            this.m_sValue = e, this.m_sCountry = "", this.m_sFormat = "", this.m_bCustomFormat = !1, this.m_bLeadingZeroRemoved = !1;
...
if (typeof SiebelApp.S_App.LocaleObject == "undefined") {
    ...
    SiebelApp.S_App.LocaleObject = function() {
        ...
        return e.prototype.ProcessObjectInfo = function(e) {
                ...
                return e && (this.m_sTimeFormat = e.GetFormat()), this
                    .m_sTimeFormat
                ...
                if (this.m_weekStartDay === undefined) {
                    var e = this.GetProfile(consts.get("LOCAL_WEEK_START_DAY")),
                        t;
                    for (t = 0; t < 7; t++)
                        if (SiebelApp.S_App.LocaleObject.GetDayOfWeek(t, 0) === e) break;
...
if (typeof SiebelApp.S_App.DatumNumberObject == "undefined") {
    ...
    SiebelApp.S_App.DatumNumberObject = function() {
        ...
        return SiebelJS.Extend(e, SiebelApp.S_App.DatumObject), e.prototype.GetAsFormattedString = function(e) {
            ...
            var t = this.m_nMinScale < 0 ? this
                .m_nScale : this.m_nMinScale,
                n = this.m_nValue.toString();
            if (n.indexOf("e") !== -1) return utils.BigNumberToString(this.m_nValue);
            var r = n.indexOf("."),
    ...
    SiebelApp.S_App.DatumDateTimeObject = function() {
        ...
        return SiebelJS.Extend(e, SiebelApp.S_App.DatumObject), e.prototype.GetAsFormattedString = function(e, t) {
            ...
            if (e >= 1753 && e <= 4712) {
                ...
                if (n >= 1) {
                    this.m_bNull = !1, this.
                    m_nYear = e, this.m_nMonth = t, this.m_nDay = Math.min(n, this.GetDaysInMonth()), this.DateToJulian();
                    return
                }
            }
            this.ResetValue(), this.SetError(!0)
