    ...
    value: function getControlsRecordSet() {
      ...
      var _loop2 = function _loop2(i) {
        ...
        ret[i] = Object.keys(ret[i]).filter(function (el) {
          ...
          return _objectSpread({}, acc, _defineProperty({}, _this9.fieldToControlMap[el].name, _this9._getControlValue(_this9.fieldToControlMap[el].uiType, ret[i][el])));
        }, {});
