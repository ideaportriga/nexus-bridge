...
function () {
  ...
  _createClass(N19baseApplet, [{
    ...
    value: function _queryById(rowId, cb) {
      ...
      psInput.SetProperty(control.GetInputName(), "Id=\"".concat(rowId, "\""));
      ai.args.push(method);
